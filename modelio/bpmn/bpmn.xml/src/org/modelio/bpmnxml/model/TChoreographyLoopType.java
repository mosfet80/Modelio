...
public enum TChoreographyLoopType {
    @objid ("b0da07cd-bf32-46d6-9ad9-a9de51469b3b")
    @XmlEnumValue("None")
    NONE("None"),
    @objid ("6b74a699-b61c-4bd3-a614-d35eef7f0ed7")
    @XmlEnumValue("Standard")
    STANDARD("Standard"),
    @objid ("3c8ecd6b-1927-4f20-9370-08fa19afcdb1")
    @XmlEnumValue("MultiInstanceSequential")
    MULTI_INSTANCE_SEQUENTIAL("MultiInstanceSequential"),
    @objid ("c87be4df-cc83-4cd2-8d4c-4397d718b067")
