...
public class BpmnDiagramEditorInput extends DiagramEditorInput {
    ...
    public BpmnDiagramEditorInput(IModelManager modelManager, AbstractDiagram diagram, GmDiagramCreator gmDiagramCreator) {
        super(diagram, modelManager, gmDiagramCreator);
    }

    @objid ("22925e5b-ea44-4a26-95c6-d4149acbf17f")
    @Override
