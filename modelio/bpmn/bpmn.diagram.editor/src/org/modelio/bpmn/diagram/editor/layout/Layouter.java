...
public class Layouter {
    ...
    private boolean routeCorner(ILayoutableLink link, org.modelio.bpmn.diagram.editor.layout.ILayoutableLink.AnchorDirection sourceAnchor, int sourceRow, int sourceCol, int targetRow, int targetCol, org.modelio.bpmn.diagram.editor.layout.ILayoutableLink.AnchorDirection targetAnchor) {
        switch (sourceAnchor) {
        case East:
