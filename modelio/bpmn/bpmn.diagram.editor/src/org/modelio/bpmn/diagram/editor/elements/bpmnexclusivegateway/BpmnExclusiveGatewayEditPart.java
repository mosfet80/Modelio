...
/**
 * EditPart for an {@link GmBpmnExclusiveGatewayPrimaryNode}.
 */
@objid ("60efc9fa-55b6-11e2-877f-002564c97630")
public final class BpmnExclusiveGatewayEditPart extends AbstractBpmnSmallNodeEditPart {
    @objid ("60efc9fe-55b6-11e2-877f-002564c97630")
    @Override
    public boolean isSelectable() {
        return false;
    }

    @objid ("60efca03-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("60efca06-55b6-11e2-877f-002564c97630")
    @Override
    protected IFigure createFigure() {
        Image image = DiagramEditorBpmn.getImageRegistry()
                .getImage(BpmnExclusiveGateway.MNAME);
    ...
    @objid ("60efca0b-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("60efca12-55b6-11e2-877f-002564c97630")
    @Override
    protected void refreshVisuals() {
        GmBpmnExclusiveGatewayPrimaryNode initialNodeModel = (GmBpmnExclusiveGatewayPrimaryNode) this.getModel();
        getFigure().getParent().setConstraint(getFigure(), initialNodeModel.getLayoutData());

    }

    @objid ("60efca15-55b6-11e2-877f-002564c97630")
    @Override
