...
public class BpmnReceiveTaskEditPart extends AbstractBpmnNodeEditPart {
    ...
    protected void refreshVisuals() {
        GmBpmnReceiveTaskPrimaryNode calloperationModel = (GmBpmnReceiveTaskPrimaryNode) getModel();
