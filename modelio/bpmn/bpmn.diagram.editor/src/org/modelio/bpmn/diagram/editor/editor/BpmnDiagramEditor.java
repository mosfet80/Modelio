...
public class BpmnDiagramEditor extends AbstractDiagramEditor {
    ...
    public static String ID = "org.modelio.bpmn.diagram.editor.BpmnDiagramEditorID";

    @objid ("943eaacc-0056-4429-9b2f-f308ea61b66b")
    private static final String POPUP_ID = "org.modelio.bpmn.diagram.editor.menu.popupmenu";
