...
public class GmBpmnUserTaskPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmBpmnUserTaskPrimaryNode(IGmDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        int readVersion = readMinorVersion(in, "GmBpmnUserTaskPrimaryNode.");
        switch (readVersion) {
        case 0: {
            read_0(in);
            break;
    ...
    public void write(IDiagramWriter out) {
        ...
        writeMinorVersion(out, "GmBpmnUserTaskPrimaryNode.", MINOR_VERSION);
