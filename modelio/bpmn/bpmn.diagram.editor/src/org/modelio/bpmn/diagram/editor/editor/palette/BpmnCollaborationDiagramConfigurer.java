...
public class BpmnCollaborationDiagramConfigurer extends AbstractDiagramConfigurer {
    ...
    private static final String COMPLETEPALETTE_ID = "org.modelio.bpmn.diagram.editor.BpmnCollaborationDiagram.PaletteID";

    @objid ("046ca6fa-5344-4fc4-abeb-f8e50f99c138")
    private static final String SIMPLEPALETTE_ID = "org.modelio.bpmn.diagram.editor.BpmnCollaborationDiagram2.PaletteID";
