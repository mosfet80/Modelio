...
public final class GmBpmnExclusiveGatewayPrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmBpmnExclusiveGatewayPrimaryNode(IGmDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        int readVersion = readMinorVersion(in, "GmBpmnExclusiveGatewayPrimaryNode.");
        switch (readVersion) {
        case 0: {
            read_0(in);
            break;
    ...
    public void write(IDiagramWriter out) {
        ...
        writeMinorVersion(out, "GmBpmnExclusiveGatewayPrimaryNode.", MINOR_VERSION);
