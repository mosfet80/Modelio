...
public class BpmnBusinessRuleTaskEditPart extends AbstractBpmnNodeEditPart {
    ...
    protected IFigure createFigure() {
        ...
        MinimumSizeLayout.apply(fig, 90, 66);
        fig.setRadius(5);
    ...
    protected void refreshVisuals() {
        GmBpmnBusinessRuleTaskPrimaryNode calloperationModel = (GmBpmnBusinessRuleTaskPrimaryNode) getModel();
