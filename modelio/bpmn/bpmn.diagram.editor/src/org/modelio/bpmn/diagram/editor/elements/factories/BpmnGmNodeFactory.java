...
import org.modelio.bpmn.diagram.editor.elements.bpmnsubprocess.content.v0.GmBpmnBodyFreeZone;
import org.modelio.bpmn.diagram.editor.elements.bpmnsubprocess.content.v0.GmBpmnBodyFreeZoneMigrator;
...
public class BpmnGmNodeFactory implements IGmNodeFactory {
    ...
    public Class<? extends IPersistent> resolveClass(String namespace) {
        try {
            ...
            if (fixedNamespace.startsWith("org.modelio.bpmn.diagram.editor")) {
                if ("org.modelio.bpmn.diagram.editor.elements.bpmnsubprocess.GmBpmnBodyFreeZone".equals(fixedNamespace)) {
    ...
    public Class<? extends IPersistentMigrator> resolveMigratorClass(String classNamespace) {
        try {
            ...
            if (fixedNamespace.startsWith("org.modelio.bpmn.diagram.editor")) {
                if ("org.modelio.bpmn.diagram.editor.elements.bpmnsubprocess.GmBpmnBodyFreeZoneMigrator".equals(fixedNamespace)) {
    ...
    public String migrateNamespace(String namespace) {
        if (namespace.startsWith("org.modelio.diagram.editor.bpmn")) {
            return namespace.replaceAll("org.modelio.diagram.editor.bpmn", "org.modelio.bpmn.diagram.editor");
        }
        return namespace;
    }
