...
public interface IInfrastructureVisitor extends MVisitor {
    ...
    abstract Object visitAbstractDiagram(AbstractDiagram obj);

    @objid ("7403638b-4da8-4a62-8d3a-5de0dd3023b2")
    abstract Object visitAbstractProject(AbstractProject obj);

    @objid ("5bb12a5d-6257-4cc0-8459-7cae424fe666")
    abstract Object visitAbstractResource(AbstractResource obj);

    @objid ("591c67bb-216a-4239-8236-e713c004eaf5")
    abstract Object visitDependency(Dependency obj);

    @objid ("691658a3-61f0-4843-a5cd-d91d506d9866")
    abstract Object visitDiagramSet(DiagramSet obj);

    @objid ("8f845b30-a403-41c2-9609-e82115b8f0dc")
    abstract Object visitDocument(Document obj);

    @objid ("1d258b3d-21d8-418e-b237-d0a67052f7a1")
    abstract Object visitDynamicPropertyDefinition(DynamicPropertyDefinition obj);
    ...
    abstract Object visitEnumeratedPropertyType(EnumeratedPropertyType obj);

    @objid ("b35a8519-6f8b-4dce-8731-a360c207f554")
    abstract Object visitExternElement(ExternElement obj);

    @objid ("3ad1ace3-fab6-4786-bfcf-89bc593ece25")
    abstract Object visitExternProcessor(ExternProcessor obj);

    @objid ("1b9644a2-d0e0-4214-a1e8-2d6f80b0b27e")
    abstract Object visitGraphDiagram(GraphDiagram obj);

    @objid ("09220b0d-8483-46b0-9f90-0f1f5023d033")
    abstract Object visitImpactDiagram(ImpactDiagram obj);

    @objid ("b34181b8-da2a-49e3-8a16-3d6361f3a756")
    abstract Object visitImpactLink(ImpactLink obj);

    @objid ("1d3f9780-ef37-4dcc-9f72-97c8f0aeb2e5")
    abstract Object visitImpactModel(ImpactModel obj);

    @objid ("78c4adf1-24c8-4bfc-b755-8521596c9fc2")
    abstract Object visitImpactProject(ImpactProject obj);

    @objid ("4853de9f-09ea-417b-bf3c-f724c6186c95")
    abstract Object visitLocalPropertyTable(LocalPropertyTable obj);

    @objid ("4db5c0b8-ab7e-47d7-9d26-bade17decb50")
    abstract Object visitMatrixDefinition(MatrixDefinition obj);

    @objid ("75f37ec3-4c99-4997-8578-41dfa3636872")
    abstract Object visitMatrixValueDefinition(MatrixValueDefinition obj);

    @objid ("456bd7ce-2d83-4331-a5d6-4578a6fabf7b")
    abstract Object visitMetaclassReference(MetaclassReference obj);

    @objid ("044694cc-c3de-41ff-9c91-e9d5c2466ae0")
    abstract Object visitMethodologicalLink(MethodologicalLink obj);

    @objid ("2d161a07-b974-48f0-bfaf-fc68a99e5e53")
    abstract Object visitModelElement(ModelElement obj);

    @objid ("0206bbf5-5fbd-4f99-82c0-2a492cc46bc9")
    abstract Object visitModuleComponent(ModuleComponent obj);

    @objid ("ccc57a01-fee6-4efd-b0dd-43be9ce07903")
    abstract Object visitModuleParameter(ModuleParameter obj);

    @objid ("d0219db6-7561-4791-a266-4ee1f1e40d73")
    abstract Object visitNote(Note obj);

    @objid ("2025f4e0-4983-40f8-a1ae-deedecf671d4")
    abstract Object visitNoteType(NoteType obj);

    @objid ("3af400f1-1085-482c-9900-01fe463ac17c")
    abstract Object visitProfile(Profile obj);

    @objid ("9f169035-2374-4f5b-ab86-ba6831eaa66d")
    abstract Object visitPropertyDefinition(PropertyDefinition obj);

    @objid ("c697749c-1aeb-4a18-906c-353db68ea1e2")
    abstract Object visitPropertyEnumerationLitteral(PropertyEnumerationLitteral obj);

    @objid ("5bf813a4-b4ac-4786-b7b4-d5bc10e7981a")
    abstract Object visitPropertyTable(PropertyTable obj);

    @objid ("c8d596e1-6599-4936-a416-0aeae8fea468")
    abstract Object visitPropertyTableDefinition(PropertyTableDefinition obj);

    @objid ("98234306-d488-4089-b6bf-24716ef9d48e")
    abstract Object visitPropertyType(PropertyType obj);

    @objid ("903d5508-00e1-4e14-82a7-dd22e53f9429")
    abstract Object visitQueryDefinition(QueryDefinition obj);
    ...
    abstract Object visitResourceType(ResourceType obj);

    @objid ("13745431-7467-4e83-8c23-c5e7acd10e93")
    abstract Object visitStereotype(Stereotype obj);

    @objid ("1284c0cf-1da2-4cf4-8b12-82a3ae6438a9")
    abstract Object visitTagParameter(TagParameter obj);

    @objid ("65076978-cd76-43f4-8cb0-f5420f95b4b3")
    abstract Object visitTagType(TagType obj);

    @objid ("7b004701-c3c6-46e3-accc-a8da2a16371e")
    abstract Object visitTaggedValue(TaggedValue obj);

    @objid ("172c7bfe-286f-41e8-bb53-711c14466a82")
    abstract Object visitTypedPropertyTable(TypedPropertyTable obj);
