...
public enum PortOrientation {
    @objid ("0eea8318-8238-4f0e-bff4-fedb39be3f09")
    NONE(0, "None", "None"),
    @objid ("c2586b1d-d895-4cef-b5b0-5442851a3218")
    IN(1, "In", "In"),
    @objid ("5c969bc2-3926-4dfe-9409-4b9c63cc5f5a")
    OUT(2, "Out", "Out"),
    @objid ("66462156-53fa-4a98-bfe8-c298da76bdc2")
    INOUT(3, "Inout", "Inout");
