...
public interface ITransactionSupport {
     ...
     * @throws ConcurrentTransactionException if a concurrent transaction is still running
     ...
     * @throws TransactionForbiddenException if creating a transaction at this state is invalid. The message will give reason of denial.
     * It typically indicates a transaction cannot be created by a {@link ITransactionListener transaction listener} or a model change listener.
     * @throws ConcurrentTransactionException if a concurrent transaction is still running after having waited.
     */
