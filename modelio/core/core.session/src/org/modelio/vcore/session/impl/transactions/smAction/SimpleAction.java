 ...
 * <p>
 * Elle connait l'objet impacte par l'action, et sauvegarde la derniere date de modification de l'objet.
 * La creation d'une nouvelle transition affectera la date de modification courante.
 */
@objid ("006e7abc-0d1e-1f20-85a5-001ec947cd2a")
public abstract class SimpleAction implements IAction, ISmAction {
    /**
     * This is the modified model object.
     */
    @objid ("006c68da-0d1e-1f20-85a5-001ec947cd2a")
    protected final SmObjectImpl refered;
