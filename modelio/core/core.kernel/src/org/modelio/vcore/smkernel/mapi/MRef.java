 ...
 * The reference is made of the object metaclass name, the object identifier and optionally the object name.
 */
...
public class MRef implements Serializable {
     ...
     * Metaclass name.
     * <p>
     * Since Modelio 6.0.1 (27/06/2024) the field is final.
     */
     ...
     *
     * @param element The element to reference.
     * @return a reference to the element, without the name.
     */
     ...
     *
     * @param uriString an URI-like string
     * @return a MRef
     * @since 5.2.0
     */
