...
public final class SmStatus implements IRStatus, IPStatus {
    ...
    static final long PFLAGS = 0x0000_ffff_0000_0000L & ~ (MASK_CMS | MASK_REPO | REMOTE);

    /**
     * Persistent flags mask area
     */
    @objid ("325165af-d27b-11e1-b069-001ec947ccaf")
    static final long PMASK = PFLAGS << 16;
    ...
    static final long RFLAGS = 0x0000_0000_0000_ffffL | MASK_CMS | MASK_REPO | REMOTE;
    ...
    private static final long RMASK = RFLAGS << 16;
    ...
    public static String toString(long status) {
        ...
        dumpIfSet(status, REMOTE, "REMOTE, ", s);
