...
public class FragmentConflictException extends GPartException {
    ...
    public FragmentConflictException(IGModelFragment orig, IGModelFragment duplicate, IGProject project) {
        this.orig = orig;
    ...
    public String getMessage() {
        return CoreProject.I18N.getMessage("FragmentConflictException",
                ...
                this.orig.getDescriptor().getLocation(), this.duplicate.getDescriptor().getLocation());
