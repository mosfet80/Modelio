...
public class ChainedMofFragmentMigrator implements IGModelFragmentMigrator, org.modelio.gproject.parts.IGModelFragmentMigrator.IMigrationProcess {
    ...
    @objid ("7c6cb5a2-356d-4451-a360-7ea72056f8f2")
    private final IGModelFragment fragToMigrate;

    @objid ("6086ad15-21a2-4157-bfaf-67b0d352a5a8")
    ...
    private void computeMetamodelMigrators() throws IOException {
        for (IGMetamodelExtension extension : this.project.getProjectEnvironment().getDefaultMetamodelExtensions()) {
            IMofRepositoryMigratorProvider mofRepoMigrator = extension.createExtension(IMofRepositoryMigratorProvider.class, this.project.getSession());
    ...
    public final void finish(IModelioProgress monitor) throws MigrationFailedException {
        ...
        try {
            ...
            // Unmount failed, try to continue anyway
            Log.warning(e);
