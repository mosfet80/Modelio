...
final class NestedBasicLogger implements IBasicLogger {
    ...
    private IMigrationLogger writer;

    @objid ("9bedfbf3-43c0-4e66-a0e8-28446603ed97")
    public NestedBasicLogger(IBasicLogger oldLog, IMigrationLogger logger) {
        this.wrapped = oldLog;
        this.writer = logger;
    ...
    public void warning(String format, Object... args) {
        ...
        this.writer.printf(NestedBasicLogger.PREFIX + "WARNING: " + format + "%n", args);
    ...
    public void trace(String format, Object... args) {
        ...
        this.writer.printf(NestedBasicLogger.PREFIX + "trace: " + format + "%n", args);
    ...
    public void error(String format, Object... args) {
        ...
        this.writer.printf(NestedBasicLogger.PREFIX + "ERROR: " + format + "%n", args);
