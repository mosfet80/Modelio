...
import org.modelio.gproject.project.GProjectFactory;
...
public class GProjectCreator {
    ...
    public static GProjectDescriptor buildEmptyProject(final String projectName, final Path projectPath) throws IOException {
