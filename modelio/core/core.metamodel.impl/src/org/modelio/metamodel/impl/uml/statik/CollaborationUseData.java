...
public class CollaborationUseData extends UmlModelElementData {
    @objid ("60306745-e9f8-4cad-9ab2-435db9ada1b1")
    SmObjectImpl mType;

    @objid ("63d4c5b2-bcd2-4c19-b033-db681199bb00")
    SmObjectImpl mNRepresented;

    @objid ("61921c22-de63-4096-892d-8ad1c9a034c0")
    SmObjectImpl mORepresented;

    @objid ("d205b792-08ff-4659-b850-65d2739cd97e")
    List<SmObjectImpl> mRoleBinding = null;

    @objid ("8659ec79-6168-4fdd-baf8-3c7591e50f01")
