...
class LaneSetCleaner {
    ...
    public static void deleteProcessEmptyLaneSets(MofSmObjectImpl process, IMigrationLogger logger) {
    ...
    private static void deleteLaneEmptyLaneSets(MofSmObjectImpl lane, IMigrationLogger logger) {
    ...
    private static void cleanupLaneSet(IMigrationLogger logger, MofSmObjectImpl laneSet, MofSmObjectImpl laneSetOwner) {
