...
public final class StandardMetamodelFragment extends AbstractMetamodelFragment {
    ...
    @objid ("25711a45-f8f1-4f00-994e-872c579c2a87")
    @Override
    public Collection<VersionedItem<MMetamodelFragment>> getNeededFragments() {
        ...
        ret.add(new VersionedItem<MMetamodelFragment>("Infrastructure", new Version("2.1.04")));

        return ret;

    }

    @objid ("17650af1-ba0b-422b-a7e2-06d2b8907904")
    public StandardMetamodelFragment() {
        	super("Standard", new Version("2.3.00"), "Modeliosoft", "3.8.00");

    }

    @objid ("5c63b37c-84fc-4368-83bc-a3fcfd84c60f")
    @Override
     ...
     */
    @objid ("bd77007e-4d66-4b13-83af-79b236a7b3a4")
    @Override
    public final Collection<SmDependencyTypeChecker> createDependencyCheckers(SmMetamodel metamodel) {
        ...
        //   'platform.core.modelio.platform.core.metamodel.standard.standard_implementation.core.metamodel.impl.org.modelio.metamodel.impl.control' package.
    ...
    @objid ("c6aa21af-3658-4c44-a5ba-b561b6d66c15")
    @Override
     ...
     */
    @objid ("8f4b08a3-5602-4bbf-a53b-4a95c8a7c7b2")
    @Override
