...
public class BpmnComplexBehaviorDefinitionData extends BpmnBaseElementData {
    @objid ("e0a4e68a-e081-4e66-86bb-c96cb4655333")
    Object mCondition = "";

    @objid ("53331a6a-3dcc-4d03-8560-d5562cdd41ea")
    SmObjectImpl mOwner;

    @objid ("2ead5bc7-ddc1-45e1-b800-b862e1549b8a")
    SmObjectImpl mEvent;

    @objid ("898de54d-731d-4226-af6f-6c1f603b6377")
