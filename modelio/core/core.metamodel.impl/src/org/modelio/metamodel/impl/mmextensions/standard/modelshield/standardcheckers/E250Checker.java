...
public class E250Checker implements IChecker {
    ...
    public void check(MObject object, final IErrorReport report) {
        ...
        if (owner != null && owner.isStereotyped("ModelerModule", "ModelComponentArchive") && !((MObject)owner).getStatusLazy().isRamc()) {
            if (utilizedElement != null && ((MObject)utilizedElement).getStatusLazy().isRamc()) {
