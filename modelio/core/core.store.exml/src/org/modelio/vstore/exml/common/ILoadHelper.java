...
public interface ILoadHelper {
     ...
     * @throws DuplicateObjectException if another object with the same identifier already exists in another repository
     * @throws IllegalReferenceException if 'id' or 'pid' is not a legal reference
     * @throws IndexException if indexes are broken
     */
