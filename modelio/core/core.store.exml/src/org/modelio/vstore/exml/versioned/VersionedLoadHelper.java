...
class VersionedLoadHelper extends LoadHelper {
    ...
    public void initObjectFlags(IModelLoader modelLoader, SmObjectImpl obj) {
        //31/03/2026: call inherited behavior to properly initialize the object flags,
        //such as "read only" for read only repositories, and reset SHELL flag for all objects.
        super.initObjectFlags(modelLoader, obj);

        this.statusInitializer.initObjectStatus(obj, modelLoader);
    }

    @objid ("839e4ea4-015e-45ab-92e3-ebfdb6d899ec")
    @Override
    public void loadFailed(SmObjectImpl obj, IModelLoader modelLoader, Exception e) {
        super.loadFailed(obj, modelLoader, e);

        this.statusInitializer.onLoadFailed(obj, modelLoader);
    }
