...
/**
 * <i>BpmnActivity</i> data model.
 * <p>
 * This class provides the list of properties for the <i>BpmnActivity</i>
 * metaclass.
 */
@objid ("21fd86fb-f459-4157-93e1-e79bab0d5a6e")
public class BpmnActivityPropertyModel extends AbstractPropertyModel<BpmnActivity> {
    /**
     * Properties to display for <i>BpmnActivity</i>.
     * <p>
    ...
    public int getRowsNumber() {
        return BpmnActivityPropertyModel.PROPERTIES.length;
    }
     ...
     */
    @objid ("1da0c9f0-fb23-4444-9d30-e088000e437c")
    private Object getValue(int row, int col) {
        switch (col) {
        case 0: // col 0 is the property key
            return getPropertyI18n(BpmnActivityPropertyModel.PROPERTIES[row]);
     ...
     */
    @objid ("f828ac94-37dd-423a-a62a-b423baa08ebe")
    @Override
     ...
     */
    @objid ("fb5b8956-1c93-4caf-b3a4-c169e0525a7a")
    @Override
