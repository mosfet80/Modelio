...
public class ProjectPropertyModel extends AbstractPropertyModel<Project> {
     ...
     * (non-Javadoc)
     *
     * @see org.modelio.property.ui.data.common.model.IPropertyModel#getValueAt(int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.modelio.property.ui.data.common.model.IPropertyModel#isEditable(int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.modelio.property.ui.data.common.model.IPropertyModel#setValueAt(int, int, java.lang.Object)
     */
