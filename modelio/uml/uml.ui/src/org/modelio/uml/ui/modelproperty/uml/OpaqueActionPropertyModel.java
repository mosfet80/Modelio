 ...
 * <p>
 * This class provides the list of properties for the <i>OpaqueAction</i>
 * metaclass.
 */
@objid ("b9a8f90e-50ef-4205-b901-2c1bd20fd20b")
public class OpaqueActionPropertyModel extends AbstractPropertyModel<OpaqueAction> {
    /**
     * Properties to display for <i>OpaqueAction</i>.
     * <p>
     ...
     * </ul>
     */
    @objid ("7d7181c2-38d9-4d09-a915-b4eb58049fa2")
    ...
    public int getRowsNumber() {
        return OpaqueActionPropertyModel.PROPERTIES.length;
    }
     ...
     */
    @objid ("7c2e3268-acd9-4878-8bda-344e234e3a4e")
     ...
     */
    @objid ("4046d88a-c3fe-4d13-a088-fa6023c4f9e7")
    @Override
    public INatValue getValueAt(int row, int col) {
        ...
        case 1: // col 1 is the property value type
            ...
            case 1:
                return new DefaultStringNatValue((String) getValue(row, col), false);
            case 2:
                return new DefaultTextNatValue((String) getValue(row, col), true);
            default:
                return null;
            }
        default:
     ...
     */
    @objid ("d206e202-2e1c-44e9-a784-e99363a3e243")
    @Override
