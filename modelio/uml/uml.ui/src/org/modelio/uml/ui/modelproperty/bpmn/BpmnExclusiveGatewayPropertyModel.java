...
/**
 * <i>BpmnExclusiveGateway</i> data model.
 * <p>
 * This class provides the list of properties for the
 * <i>BpmnExclusiveGateway</i> metaclass.
 */
@objid ("84b44dbf-213e-423d-9e4f-edfded3a4432")
public class BpmnExclusiveGatewayPropertyModel extends AbstractPropertyModel<BpmnExclusiveGateway> {
    /**
     * Properties to display for <i>BpmnExclusiveGateway</i>.
     * <p>
     ...
     * </ul>
     */
    @objid ("310b449f-9901-46ff-92aa-469984429fbc")
    ...
    public BpmnExclusiveGatewayPropertyModel(BpmnExclusiveGateway theEditedElement) {
    ...
    public int getRowsNumber() {
        return BpmnExclusiveGatewayPropertyModel.PROPERTIES.length;
    }
     ...
     */
    @objid ("6ba9a222-16c9-4382-a410-1dec60653b20")
     ...
     */
    @objid ("cd479a33-a9a3-4111-8631-37466a73b7d8")
    @Override
     ...
     */
    @objid ("135729b9-ef15-4f41-ad6c-e45ceae59c8e")
    @Override
