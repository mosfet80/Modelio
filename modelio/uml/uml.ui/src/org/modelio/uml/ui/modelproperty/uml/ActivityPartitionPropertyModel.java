...
/**
 * <i>ActivityPartition</i> data model.
 * <p>
 * This class provides the list of properties for the <i>ActivityPartition</i>
 * metaclass.
 */
@objid ("0ebbf1e9-583d-4776-b1a0-96785e277e60")
public class ActivityPartitionPropertyModel extends AbstractPropertyModel<ActivityPartition> {
    /**
     * Properties to display for <i>ActivityPartition</i>.
     * <p>
    ...
    public int getRowsNumber() {
        return ActivityPartitionPropertyModel.PROPERTIES.length;
    }
     ...
     */
    @objid ("637c5a66-f996-4c44-894a-b268364cdb5b")
    private Object getValue(int row, int col) {
        ...
        case 1: // col 1 is the property value
            ...
            case 2:
                return new Boolean(this.theEditedElement.isIsDimension());
            case 3:
                return new Boolean(this.theEditedElement.isIsExternal());
            case 4:
     ...
     */
    @objid ("81581b6f-8de3-4911-bd36-a46771acaa49")
    @Override
     ...
     */
    @objid ("3df4ec08-bd39-4c8b-9e70-28f497364d1d")
    @Override
    public void setValueAt(int row, int col, Object value) {
        ...
        case 1: // col 1 is the property value
            ...
            case 1:
                ...
                break;
            case 2:
                this.theEditedElement.setIsDimension(((Boolean) value).booleanValue());
                break;
            case 3:
                this.theEditedElement.setIsExternal(((Boolean) value).booleanValue());
                break;
            case 4:
                this.theEditedElement.setRepresented((UmlModelElement) value);
                break;
            default:
                return;
            }
