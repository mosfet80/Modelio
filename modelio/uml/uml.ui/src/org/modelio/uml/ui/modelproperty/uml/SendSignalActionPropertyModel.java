 ...
 * <p>
 * This class provides the list of properties for the <i>SendSignalAction</i>
 * metaclass.
 */
@objid ("bfe495ca-e52f-4e67-abc3-759eabc60eb6")
public class SendSignalActionPropertyModel extends AbstractPropertyModel<SendSignalAction> {
     ...
     * </ul>
     */
    @objid ("b4c58395-69f8-4196-ab1b-7e67623900c6")
    private static final String[] PROPERTIES = new String[] { AbstractPropertyModel.PROPERTY_ID, "Name", "Sent" };
     ...
     */
    @objid ("0a95fbad-0f78-48ee-b766-d7254ff28a8a")
     ...
     */
    @objid ("d52f1251-3e4e-482b-b821-1d4104c007eb")
    @Override
     ...
     */
    @objid ("a54d98c7-da1b-4a3d-81e2-7b0e50f89be4")
    @Override
