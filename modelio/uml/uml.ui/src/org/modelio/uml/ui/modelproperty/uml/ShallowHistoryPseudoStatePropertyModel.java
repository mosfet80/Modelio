 ...
 * <i>ShallowHistoryPseudoState</i> metaclass.
 */
@objid ("bbb70f2e-ac5a-4876-9277-4fb7d0c4d1f9")
public class ShallowHistoryPseudoStatePropertyModel extends AbstractPropertyModel<ShallowHistoryPseudoState> {
     ...
     * </ul>
     */
    @objid ("fa197da0-4a24-4d34-8824-a9e4f515a2e1")
    private static final String[] PROPERTIES = new String[] { AbstractPropertyModel.PROPERTY_ID, "Name" };

    /**
     * Create a new <i>ShallowHistoryPseudoState</i> data model from an
     * <i>ShallowHistoryPseudoState</i>.
     *
     * @param theEditedElement the model to edit.
     */
    @objid ("6045f0ac-a4fc-41e5-ba9a-51ab51e38651")
     ...
     */
    @objid ("67680b24-3010-49ab-817f-cd827d48574d")
    @Override
     ...
     */
    @objid ("d3d80140-7672-41b5-b1c2-84e5db9ed6df")
    @Override
     ...
     */
    @objid ("05cd4220-a02a-4bc4-9dfa-99f91305ad44")
     ...
     */
    @objid ("94e8f838-9638-47f3-a342-b8e5c31fcf8a")
    @Override
     ...
     */
    @objid ("afe1a1de-d6d4-40bd-8702-6e312044ee9c")
    @Override
