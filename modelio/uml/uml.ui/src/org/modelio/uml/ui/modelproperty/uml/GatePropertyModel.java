 ...
 */
@objid ("97d24490-06b9-4cb0-bcbf-b0e78a455760")
public class GatePropertyModel extends AbstractPropertyModel<Gate> {
     ...
     * </ul>
     */
    @objid ("7b27794d-87c9-4627-8709-7f8d0c6c16fd")
    private static final String[] PROPERTIES = new String[] { AbstractPropertyModel.PROPERTY_ID, "Name", "Formal" };
     ...
     */
    @objid ("d3e98adf-76b9-4a7f-9659-27bf5b7320ad")
     ...
     */
    @objid ("f44d602c-1e40-4428-a23e-fac8026f5935")
    @Override
    public INatValue getValueAt(int row, int col) {
        ...
        case 1: // col 1 is the property value type
            ...
            case 1:
                return new DefaultStringNatValue((String) getValue(row, col), false);
            case 2:
                return new DefaultElementNatValue((MObject) getValue(row, col), false, Collections.singletonList(Gate.class));
            default:
                return null;
            }
        default:
     ...
     */
    @objid ("fee36dd3-c72a-4172-90ad-37977f9cca1f")
    @Override
