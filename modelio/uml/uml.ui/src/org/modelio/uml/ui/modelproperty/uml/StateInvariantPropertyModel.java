 ...
 * <p>
 * This class provides the list of properties for the <i>StateInvariant</i>
 * metaclass.
 */
@objid ("3ad7cf58-1054-4065-a6c7-2b0a67eedbe2")
public class StateInvariantPropertyModel extends AbstractPropertyModel<StateInvariant> {
     ...
     * </ul>
     */
    @objid ("2cfc140f-0501-4dbe-9c90-5e27d914cecc")
    private static final String[] PROPERTIES = new String[] { AbstractPropertyModel.PROPERTY_ID, "Body" };
     ...
     */
    @objid ("9cfd16ec-60b8-4f69-ae04-e4475ef9aa65")
     ...
     */
    @objid ("cb3230a9-7e5a-46c5-a283-9e16b7fbaa61")
    @Override
     ...
     */
    @objid ("a40862df-4143-48e6-915e-c5376f25392c")
    @Override
