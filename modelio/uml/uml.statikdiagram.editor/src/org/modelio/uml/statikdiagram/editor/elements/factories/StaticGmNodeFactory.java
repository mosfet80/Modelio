...
import org.modelio.uml.statikdiagram.editor.elements.abstraction.GmAbstractionHeader;
...
import org.modelio.uml.statikdiagram.editor.elements.collabuse.GmCollaborationUseFlatLabel;
...
import org.modelio.uml.statikdiagram.editor.elements.elementRealization.GmElementRealizationHeader;
...
import org.modelio.uml.statikdiagram.editor.elements.informationconveyed.GmConveyedInformationItemLabel;
...
import org.modelio.uml.statikdiagram.editor.elements.informationitem.GmInformationItemLabel;
...
public class StaticGmNodeFactory implements IGmNodeFactory {
    ...
    @objid ("bcb34e0b-404b-43ba-9248-feca5ed43028")
    @Override
    public String migrateNamespace(String namespace) {
        if (namespace.startsWith("org.modelio.diagram.editor.statik")) {
            return namespace.replaceAll("org.modelio.diagram.editor.statik", "org.modelio.uml.statikdiagram.editor");
        }
        return namespace;
    }
