...
/**
 * EditPart for an BpmnBehavior Node.
 */
@objid ("34182f7a-55b7-11e2-877f-002564c97630")
public class BpmnBehaviorEditPart extends AbstractNodeEditPart {
    @objid ("34182f7e-55b7-11e2-877f-002564c97630")
    @Override
    public boolean isSelectable() {
        return false;
    }

    @objid ("34182f83-55b7-11e2-877f-002564c97630")
    @Override
    protected void addChildVisual(final EditPart childEditPart, final int index) {
        ...
        if (index == 0 && gmAbstractObject.getLayoutData() == null) {
            ...
            throw new IllegalArgumentException("BpmnBehavior#addChildVisual: unknown index " + index);
        }
        getFigure().add(child, gmAbstractObject.getLayoutData(), index);

    }

    @objid ("34182f8a-55b7-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("34182f8d-55b7-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("34182f92-55b7-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("3419b61d-55b7-11e2-877f-002564c97630")
    @Override
    protected void refreshVisuals() {
        GmBpmnBehaviorPrimaryNode callBehaviorModel = (GmBpmnBehaviorPrimaryNode) getModel();
