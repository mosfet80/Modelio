 ...
 */
@objid ("3492417a-55b7-11e2-877f-002564c97630")
public class CommunicationInteractionEditPart extends AbstractNodeEditPart {
    @objid ("3492417e-55b7-11e2-877f-002564c97630")
    @Override
    public boolean isSelectable() {
        return false;
    }

    @objid ("34924183-55b7-11e2-877f-002564c97630")
    @Override
    protected void addChildVisual(final EditPart childEditPart, final int index) {
        ...
        if (index == 0 && gmAbstractObject.getLayoutData() == null) {
            ...
            throw new IllegalArgumentException("CommunicationInteraction#addChildVisual: unknown index " +
                                               index);
        }
    ...
    @objid ("3493c81b-55b7-11e2-877f-002564c97630")
    @Override
