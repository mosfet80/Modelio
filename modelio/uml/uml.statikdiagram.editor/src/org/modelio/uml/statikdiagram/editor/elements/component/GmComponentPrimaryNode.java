...
public class GmComponentPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public RepresentationMode getRepresentationMode() {
        return getDisplayedStyle().getProperty(GmComponent.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        int readVersion = readMinorVersion(in, "GmComponentPrimaryNode.");
        switch (readVersion) {
        case 0: {
            read_0(in);
            break;
    ...
    private void read_0(IDiagramReader in) {
        ...
        GmDefaultModelElementLabel imageHeader = (GmDefaultModelElementLabel) children.get(7);
        if (imageHeader != null) {
            imageHeader.delete();
        }
