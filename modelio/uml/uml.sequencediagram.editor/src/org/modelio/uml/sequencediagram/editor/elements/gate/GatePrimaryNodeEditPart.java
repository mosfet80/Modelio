 ...
 * @author fpoyer
 */
@objid ("d8f5cd8b-55b6-11e2-877f-002564c97630")
public class GatePrimaryNodeEditPart extends AbstractNodeEditPart {
    @objid ("d8f5cd8f-55b6-11e2-877f-002564c97630")
    private FigureUpdater figureUpdater = new FigureUpdater(this);

    @objid ("d8f5cd90-55b6-11e2-877f-002564c97630")
    @Override
    public Command getCommand(final Request request) {
        ...
        if (RequestConstants.REQ_RESIZE.equals(request.getType()) &&
            ...
            Command updateModelCommand = new Command() {
                @Override
                public void execute() {
                    GmGatePrimaryNode model = (GmGatePrimaryNode) GatePrimaryNodeEditPart.this.getModel();
                    Gate gate = (Gate) model.getRelatedElement();
                    int newTime = GatePrimaryNodeEditPart.this.getFigure().getBounds().getCenter().y +
    ...
    @objid ("d8f5cd97-55b6-11e2-877f-002564c97630")
    @Override
    public boolean isSelectable() {
        return false;
    }

    @objid ("d8f753fc-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("d8f75401-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("d8f75404-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("d8f75409-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("d8f7540c-55b6-11e2-877f-002564c97630")
    @Override
