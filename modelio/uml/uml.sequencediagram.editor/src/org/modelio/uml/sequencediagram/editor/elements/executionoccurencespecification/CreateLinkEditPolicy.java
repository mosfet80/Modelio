 ...
 */
@objid ("d8d5c252-55b6-11e2-877f-002564c97630")
public class CreateLinkEditPolicy extends DefaultCreateLinkEditPolicy {
    @objid ("d8d5c256-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("d8d748de-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("d8d748e5-55b6-11e2-877f-002564c97630")
    @Override
    ...
    protected EditPart getTargetEditPartConnectionEnd(final CreateConnectionRequest request) {
        ...
        if (context != null) {
            if (Message.class == context.getJavaClass()) {
                ...
                ExecutionOccurenceSpecification element = (ExecutionOccurenceSpecification) gmModel.getRelatedElement();
                if (element.getSentMessage() != null || element.getReceivedMessage() != null) {
                    return null;
                }
            }
        }
        return super.getTargetEditPartConnectionEnd(request);
    }

    @objid ("d8d748f1-55b6-11e2-877f-002564c97630")
    @Override
    protected EditPart getTargetEditPartConnectionStart(final CreateConnectionRequest request) {
        ...
        return super.getTargetEditPartConnectionStart(request);
    }
