...
public class DeploymentDiagramEditor extends AbstractDiagramEditor {
    ...
    public static final String ID = "org.modelio.uml.deploymentdiagram.editor.DeploymentDiagramEditorID";

    @objid ("400964e8-8d32-4993-8c38-ed78ee7ff557")
    private static final String POPUP_ID = "org.modelio.uml.deploymentdiagram.editor.menu.popupmenu";
