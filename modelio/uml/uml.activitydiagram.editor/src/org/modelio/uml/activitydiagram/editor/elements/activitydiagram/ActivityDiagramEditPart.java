 ...
 * @author fpoyer
 */
@objid ("298d5280-55b6-11e2-877f-002564c97630")
public class ActivityDiagramEditPart extends AbstractDiagramEditPart {
    @objid ("298d5284-55b6-11e2-877f-002564c97630")
    @Override
    protected IFigure createFigure() {
        Figure diagramFigure = new ActivityDiagramFigure();
    ...
    @objid ("298d5289-55b6-11e2-877f-002564c97630")
    @Override
    protected void createEditPolicies() {
        super.createEditPolicies();

        // Policy to add nodes on the diagram
        installEditPolicy(EditPolicy.LAYOUT_ROLE, new ActivityDiagramLayoutPolicy());
