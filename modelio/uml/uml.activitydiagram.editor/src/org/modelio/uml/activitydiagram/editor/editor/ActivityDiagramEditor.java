...
public class ActivityDiagramEditor extends AbstractDiagramEditor {
    ...
    public static final String ID = "org.modelio.uml.activitydiagram.editor.ActivityDiagramEditorID";

    @objid ("ca6b72be-ae21-415e-afdf-82cb1083e6b5")
    private static final String POPUP_ID = "org.modelio.uml.activitydiagram.editor.menu.popupmenu";
