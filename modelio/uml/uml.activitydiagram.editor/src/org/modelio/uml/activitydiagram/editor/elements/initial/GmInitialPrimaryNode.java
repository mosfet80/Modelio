...
/**
 * Represents an {@link IInitialNode}.
 */
@objid ("2a9ceded-55b6-11e2-877f-002564c97630")
public final class GmInitialPrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    /**
     * Current version of this Gm. Defaults to 0.
     */
    @objid ("2a9cedf3-55b6-11e2-877f-002564c97630")
    private static final int MINOR_VERSION = 0;

    @objid ("2a9cedf6-55b6-11e2-877f-002564c97630")
    ...
    @objid ("2a9e745f-55b6-11e2-877f-002564c97630")
    @Override
    public InitialNode getRelatedElement() {
        return (InitialNode) super.getRelatedElement();
    }

    @objid ("2a9e7466-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("2a9e7471-55b6-11e2-877f-002564c97630")
    @Override
    ...
    public RepresentationMode getRepresentationMode() {
        final StyleKey repModeKey = GmInitial.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE);
        return getDisplayedStyle().getProperty(repModeKey);
    }

    @objid ("2a9e7481-55b6-11e2-877f-002564c97630")
    @Override
    public Image getImage() {
        return ElementImageService.getImage(getRelatedElement());
    }

    @objid ("2a9e7486-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("2a9e7490-55b6-11e2-877f-002564c97630")
    @Override
    public void read(IDiagramReader in) {
        // Read version, defaults to 0 if not found
        int readVersion = readMinorVersion(in, "GmInitialPrimaryNode.");
        switch (readVersion) {
        case 0: {
            read_0(in);
            break;
    ...
    @objid ("2a9ffafe-55b6-11e2-877f-002564c97630")
    @Override
