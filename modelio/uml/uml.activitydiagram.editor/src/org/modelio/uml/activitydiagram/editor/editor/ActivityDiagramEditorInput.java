...
public class ActivityDiagramEditorInput extends DiagramEditorInput {
    ...
    public ActivityDiagramEditorInput(IModelManager modelManager, AbstractDiagram diagram, GmDiagramCreator gmDiagramCreator) {
        super(diagram, modelManager, gmDiagramCreator);
    }

    @objid ("c560af6a-625f-4a00-a162-aa720963d8a1")
    @Override
