...
public class GmJunctionPrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmJunctionPrimaryNode(IGmDiagram diagram, MRef relatedRef) {
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getDisplayedStyle().getProperty(GmJunction.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        int readVersion = readMinorVersion(in, "GmJunctionPrimaryNode.");
        switch (readVersion) {
        case 0: {
            read_0(in);
            break;
    ...
    public void write(IDiagramWriter out) {
        ...
        writeMinorVersion(out, "GmJunctionPrimaryNode.", GmJunctionPrimaryNode.MINOR_VERSION);
