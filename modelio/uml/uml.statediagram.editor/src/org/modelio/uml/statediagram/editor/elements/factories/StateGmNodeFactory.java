...
public class StateGmNodeFactory implements IGmNodeFactory {
    ...
    public Class<? extends IPersistent> resolveClass(String namespace) {
        try {String fixedNamespace = migrateNamespace(namespace);
            if (fixedNamespace.startsWith("org.modelio.uml.statediagram.editor")) {
    ...
    public Class<? extends IPersistentMigrator> resolveMigratorClass(String classNamespace) {
        try {String fixedNamespace = migrateNamespace(classNamespace);
            Class<?> clazz = Class.forName(fixedNamespace);
            if (clazz != null) {
    ...
    public Class<? extends Enum<?>> resolveEnumClass(String enumNamespace) {
        try {String fixedNamespace = migrateNamespace(enumNamespace);
            Class<?> clazz = Class.forName(fixedNamespace);
    ...
    @objid ("6cfe6abc-da65-4f83-b854-3c6d0dbd7f9c")
    @Override
    public String migrateNamespace(String namespace) {
        if (namespace.startsWith("org.modelio.diagram.editor.state")) {
            return namespace.replaceAll("org.modelio.diagram.editor.state", "org.modelio.uml.statediagram.editor");
        }
        return namespace;
    }
