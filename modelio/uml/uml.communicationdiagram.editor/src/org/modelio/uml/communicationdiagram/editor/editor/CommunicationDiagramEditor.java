...
public class CommunicationDiagramEditor extends AbstractDiagramEditor {
    ...
    public static final String ID = "org.modelio.uml.communicationdiagram.editor.CommunicationDiagramEditorID";

    @objid ("5d1f1b00-17e2-4f64-8a73-c3330f3aa776")
    private static final String POPUP_ID = "org.modelio.uml.communicationdiagram.editor.menu.popupmenu";
