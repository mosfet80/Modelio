...
public class CommunicationDiagramEditorInput extends DiagramEditorInput {
    ...
    public CommunicationDiagramEditorInput(IModelManager modelManager, AbstractDiagram diagram, GmDiagramCreator gmDiagramCreator) {
        super(diagram, modelManager, gmDiagramCreator);
    }

    @objid ("0794cc13-0792-4a65-925b-18e47c96099c")
    @Override
