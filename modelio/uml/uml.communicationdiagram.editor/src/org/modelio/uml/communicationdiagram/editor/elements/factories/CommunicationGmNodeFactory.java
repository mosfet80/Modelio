...
public final class CommunicationGmNodeFactory implements IGmNodeFactory {
    ...
    @objid ("f31c9aaa-33b5-4738-bef6-cdebc8c5966e")
    @Override
    public String migrateNamespace(String namespace) {
        if (namespace.startsWith("org.modelio.diagram.editor.communication")) {
            return namespace.replace("org.modelio.diagram.editor.communication", "org.modelio.uml.communicationdiagram.editor");
        }
        return namespace;
    }
