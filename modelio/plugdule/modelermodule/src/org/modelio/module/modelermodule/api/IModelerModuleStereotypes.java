...
public interface IModelerModuleStereotypes {
    ...
    @objid ("b0941b50-6fb7-4de5-ac68-95a2487d585f")
    public static final String ANTONYM = "antonym";

    @objid ("5331e08e-46e3-4ac1-8f85-2f8df1ec2b1a")
    public static final String ASSIGNED = "assigned";

    @objid ("cf3e7430-eb2b-49cb-a3f0-76ef456de429")
    public static final String BUSINESS_RULE_DIAGRAM = "business_rule_diagram";

    @objid ("021538fd-b7b4-4c10-b5bc-070b210d9479")
    public static final String BUSINESS_RULE_PROPERTYSET = "business_rule_propertyset";

    @objid ("ea0c0c2b-417b-4b2f-bb94-38d567540f97")
    public static final String CATCH = "catch";

    @objid ("c7831b08-f6a7-40fa-b09f-b30cd2ecb90f")
    public static final String CLASS = "class";

    @objid ("6869dd8e-0f52-4309-9d94-fa71297a2bf1")
    public static final String COLLABORATION = "collaboration";

    @objid ("98790ebc-5c2a-4c8e-8032-1465309eba4b")
    public static final String COMMUNICATION = "communication";

    @objid ("ecd601ef-99e9-4f8b-97fc-023447ba3aa4")
    public static final String COMPLETE = "complete";

    @objid ("8541dae2-1714-4f70-a7e9-55200324c3b3")
    public static final String CONTEXT = "context";

    @objid ("3c384717-760c-47fb-9e45-232c9eab44c4")
    public static final String CREATE = "create";

    @objid ("8df7bfaf-f203-432a-9b7f-78ebb4e0a9d7")
    public static final String DEPLOYMENT = "deployment";

    @objid ("26484b62-d2ad-4bc9-bb71-8072777fad79")
    public static final String DERIVE = "derive";

    @objid ("2a39c564-ce9d-47b2-93c2-bb43e345b13a")
    public static final String DESIGNPATTERN = "design pattern";

    @objid ("879c386e-b033-46db-9b3f-8d9489385eb8")
    public static final String DESIGN_PATTERN = "design pattern";

    @objid ("d1d86eb6-7cf0-4074-8d47-dadddbcbc77a")
    public static final String DESTROY = "destroy";

    @objid ("85a83596-56ca-4dca-9915-fa10ce24693b")
    public static final String DESTROYED = "destroyed";

    @objid ("ee283829-8e9a-4063-a592-0604b07188c3")
    public static final String DICTIONARY_DIAGRAM = "dictionary_diagram";

    @objid ("e80e7b7d-038f-492f-8387-3c4b7c2b0d96")
    public static final String DICTIONARY_PROPERTYSET = "dictionary_propertyset";

    @objid ("f84c6950-d116-4dcf-84bf-a29475a404b4")
    public static final String DIRECTORY = "directory";

    @objid ("29cd4f31-4e04-4c48-bca0-86d13b8ed360")
    public static final String DISJOIN = "disjoin";

    @objid ("28971631-04d7-46d8-a99e-ed8612836484")
    public static final String EXCEPTION = "exception";

    @objid ("6d78060b-7822-4ab6-a243-a118e98dd8a2")
    public static final String EXECUTABLE = "executable";

    @objid ("3786f982-abd1-4184-bc6b-51686dc353b7")
    public static final String EXTEND = "extend";

    @objid ("b60a1c77-482a-464c-8b6a-e83c7149cf9f")
    public static final String EXTERNALDOCUMENT = "ExternalDocument";

    @objid ("16f91541-cf70-4332-9d6a-e88d10e9a79e")
    public static final String FACADE = "facade";

    @objid ("cc93a8b3-810e-4d01-a5b8-cc38d27466ac")
    public static final String FILE = "file";

    @objid ("8753baaa-e3d9-4b2e-a82c-b935c445a4bc")
    public static final String FLOW = "flow";

    @objid ("a5cbe2b4-b239-4f22-b86a-b3d4fc8b0b39")
    public static final String FRAMEWORK = "frameWork";

    @objid ("7024deda-cbcf-451c-9393-aecada30cb35")
    public static final String FRIEND = "friend";

    @objid ("06fa00c6-1344-46c5-9fed-81a3eb361b93")
    public static final String GOAL_DIAGRAM = "goal_diagram";

    @objid ("8e967db9-005a-457b-a89d-dac3d6ede7f5")
    public static final String GOAL_PROPERTYSET = "goal_propertyset";

    @objid ("6029cf0c-c1c3-45e4-b241-8e6d88a6d6c1")
    public static final String GUARANTEE = "guarantee";

    @objid ("2336f89a-121f-4ba2-9ca5-74fe316dc272")
    public static final String HOMONYM = "homonym";

    @objid ("5f235712-171b-4808-8317-f6a1f0c6ff91")
    public static final String IMPACT = "impact";

    @objid ("834f51bf-49cd-4f5f-9273-8c5da335d59f")
    public static final String IMPACT_ROOT = "impact_root";

    @objid ("c6f29185-e3f5-41e0-bfb8-448fa6851c78")
    public static final String IMPACT_SUBROOT = "impact_subroot";

    @objid ("c62e2480-2201-485c-b9b8-a7bfe20386bb")
    public static final String IMPLEMENT = "implement";

    @objid ("6c69dd7b-da7d-4cce-89ce-675b78e8ba52")
    public static final String IMPLEMENTATION = "implementation";

    @objid ("58d91464-e547-4f2c-a3d0-cfd2fe6eaacf")
    public static final String IMPLEMENTATIONCLASS = "implementationClass";

    @objid ("1f2cd58d-5d5a-47e5-8aa5-4ed2ea8539e6")
    public static final String IMPLICIT = "implicit";

    @objid ("0b73ccba-ceee-4c31-b76d-f79c56b38077")
    public static final String IMPORT = "import";

    @objid ("c3622c23-6a76-442f-ac65-7250a5d1d5d5")
    public static final String INCLUDE = "include";

    @objid ("d3aa7d03-0106-44b6-a77f-cbcf284346a2")
    public static final String INCOMPLETE = "incomplete";

    @objid ("7662410f-6bfe-4b57-a1a4-4d19e78d5d80")
    public static final String INSTANTIATE = "instantiate";

    @objid ("cd075330-4c50-4b73-891d-9254524b8215")
    public static final String INVARIANT = "invariant";

    @objid ("7ed00dd0-99c5-45f4-9d04-a67931ed55a4")
    public static final String KIND_OF = "kind-of";

    @objid ("35df4d9c-4aad-4ce5-8d5d-943e5aa5db10")
    public static final String KINDmoinsOF = "kind-of";

    @objid ("a5d12c69-8fa2-4bf3-8aaf-84a03b1ad2f5")
    public static final String LIBRARY = "library";

    @objid ("98054188-ec7d-48b7-9c1c-dcaf0e882300")
    public static final String MAIL = "mail";

    @objid ("b844e5cf-4712-4714-8680-3b9f4036be0a")
    public static final String MEASURE = "measure";

    @objid ("40994d38-8788-4326-a7ae-e5a989c54595")
    public static final String METACLASS = "metaclass";

    @objid ("65e02d5a-d958-4f31-ace0-764433da8cf7")
    public static final String METAMODEL = "metamodel";

    @objid ("b5198b9d-5799-43e2-a7b8-804f8ffe3a78")
    public static final String MODELCOMPONENT = "ModelComponent";

    @objid ("cfdfcc22-a568-477b-9282-c1238668a97f")
    public static final String MODELCOMPONENTARCHIVE = "ModelComponentArchive";

    @objid ("106b9e2d-6d3d-4f4e-9560-5795e3fb7c37")
    public static final String MODELCOMPONENTELEMENTALIAS = "ModelComponentElementAlias";

    @objid ("b76fd323-e544-40f4-9884-89f11957b9f2")
    public static final String NEW = "new";

    @objid ("bbda9954-4820-4ee0-8da0-5e1755df6435")
    public static final String OBJECT = "object";

    @objid ("8ff33531-e788-4088-a004-7dd9e6654ab3")
    public static final String ORDERED = "ordered";

    @objid ("082596d4-4466-42f6-a679-3e2991fb2296")
