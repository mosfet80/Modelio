...
/**
 * Handler for the Repaking layout.
 * <p>
 ...
 * </p>
 */
@objid ("fbd4bd5f-9e48-4639-a780-7ba5f0e0322d")
public class RectPackingLayoutHandler {
    @objid ("bc9df4ac-854d-4ca8-bff6-46902a8e5179")
    @Execute
    public void execute(@Named(IServiceConstants.ACTIVE_SELECTION) final ISelection selection, @Named(IServiceConstants.ACTIVE_PART) final MPart part, IProjectService projectService, IModelioEventService eventService, IEclipseContext eclipseContext) {
        ...
        try (ITransaction transaction = projectService.getSession().getTransactionSupport().createTransaction("PackingLayoutHandler - > Run Packing Layout");) {
            DiagramLayoutEngine.createLayoutAlgorithme(LayoutAlgorithmeType.PACKING).withDiagram(diagram, diagramService)
    ...
    @objid ("08ed148a-c67d-45d8-82f9-fd677ddbd8c4")
    @CanExecute
