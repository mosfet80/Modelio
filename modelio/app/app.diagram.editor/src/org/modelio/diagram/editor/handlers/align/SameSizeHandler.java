...
@objid ("65c52b14-33f7-11e2-95fe-001ec947c8cc")
public class SameSizeHandler extends AbstractAlignHandler {
    @objid ("65c52b15-33f7-11e2-95fe-001ec947c8cc")
    @Override
    protected void align(GraphicalEditPart primarySelection, List<GraphicalEditPart> otherSelections) {
        ...
        CompoundCommand compound = new CompoundCommand("Same size");
        for (GraphicalEditPart editPart : otherSelections) {
            ...
            req.setSizeDelta(new Dimension(primaryBounds.width - bounds.width, primaryBounds.height - bounds.height));
