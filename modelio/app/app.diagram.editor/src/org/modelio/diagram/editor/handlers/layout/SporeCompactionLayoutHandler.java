...
/**
 * Handler for the Compaction layout.
 * <p>
 ...
 * </p>
 */
@objid ("672e8b62-6204-497a-95df-a0ebc36c7903")
public class SporeCompactionLayoutHandler {
    @objid ("a655f4f3-aef5-4ba4-8fcb-e50c26192f33")
    @Execute
    public void execute(@Named(IServiceConstants.ACTIVE_SELECTION) final ISelection selection, @Named(IServiceConstants.ACTIVE_PART) final MPart part, IProjectService projectService, IModelioEventService eventService, IEclipseContext eclipseContext) {
        ...
        try (ITransaction transaction = projectService.getSession().getTransactionSupport().createTransaction("SporeCompactionLayoutHandler - > Run Compaction Layout");) {
            DiagramLayoutEngine.createLayoutAlgorithme(LayoutAlgorithmeType.COMPACTION)
    ...
    @objid ("06e33c72-a99f-4b13-9695-d0f491f5d16a")
    @CanExecute
