...
public interface IDiagramEditorInputProvider {
    /**
     * Instantiate a {@link DiagramEditorInput} for a diagram.
     *
     ...
     * @deprecated Call {@link #compute(AbstractDiagram, IModelManager)} instead.
     * This methods implies plenty lookups by identifier without knowing the metaclass.
     */
    @objid ("be793a8b-5a77-11e2-9c97-002564c97630")
    @Deprecated(since = "> 6.0.1 02/12/2024", forRemoval = true)
    DiagramEditorInput compute(String diagramUid, IModelManager modelManager);

    /**
     * Instantiate a {@link DiagramEditorInput} for a diagram.
     *
     * @param diagram an existing diagram
     * @param modelManager a diagram model manager.
     * @return the editor input, or <code>null</code> if the diagram's instance can't be handled by this provider.
     * @since > 6.0.1 02/12/2024
     */
    @objid ("4e00078f-67a3-45ee-acf3-6f20dc0b95eb")
    DiagramEditorInput compute(AbstractDiagram diagram, IModelManager modelManager);
    ...
    interface GmDiagramCreator {
         ...
         * <p>
         * Warning: returned gm is neither loaded nor visible, it should be done by the caller.
         * <p>
         * <code>
