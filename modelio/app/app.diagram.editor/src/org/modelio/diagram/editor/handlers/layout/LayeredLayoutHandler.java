...
/**
 * Handler for the Layered layout.
 * <p>
 ...
 * </p>
 */
@objid ("292817cf-dab2-454a-bc64-86099b56ddbf")
public class LayeredLayoutHandler {
    @objid ("29453819-6174-4a01-9522-6134d1be3e24")
    @Execute
    public void execute(@Named(IServiceConstants.ACTIVE_SELECTION) final ISelection selection, @Named(IServiceConstants.ACTIVE_PART) final MPart part, IProjectService projectService, IModelioEventService eventService, IEclipseContext eclipseContext) {
        ...
        try (ITransaction transaction = projectService.getSession().getTransactionSupport().createTransaction("LayeredLayoutHandler - > Run Layered Layout");) {
            DiagramLayoutEngine.createLayoutAlgorithme(LayoutAlgorithmeType.LAYERED)
    ...
    @objid ("8e7ba7a3-2dc1-4ad7-92a6-0a4f1a04ec5e")
    @CanExecute
