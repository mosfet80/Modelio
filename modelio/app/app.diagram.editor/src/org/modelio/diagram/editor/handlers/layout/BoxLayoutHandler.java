 ...
 * </p>
 */
@objid ("c6529026-5a2d-4c88-b030-dda9d159022b")
public class BoxLayoutHandler {
    @objid ("230a8d50-846c-4034-8890-669ac2502a76")
    @Execute
    public void execute(@Named(IServiceConstants.ACTIVE_SELECTION) final ISelection selection, @Named(IServiceConstants.ACTIVE_PART) final MPart part, IProjectService projectService, IModelioEventService eventService, IEclipseContext eclipseContext) {
        ...
        try (ITransaction transaction = projectService.getSession().getTransactionSupport().createTransaction("BoxLayoutHandler - > Run Box Layout");) {

                DiagramLayoutEngine.createLayoutAlgorithme(LayoutAlgorithmeType.BOX).withDiagram(diagram, diagramService)
    ...
    @objid ("f1f10665-c20a-46e4-8e4e-760803704d11")
    @CanExecute
