...
public interface IRichNoteEditorProvider {
    ...
    abstract void createEmptyFile(final MObject target, RichNoteFormat format, IRichNoteFileRepository richRepository) throws IOException;
    ...
    abstract IRichNoteDiffMerger getDiffMerge();
    ...
    abstract String getEditorId(final MObject target);
