...
public class UMLModel implements IUmlModel {
    ...
    /**
     * Create Create an instance of the MObject class with specified Identifier
     * Using this method poses risks to the integrity of the repository. We advise against its use and do not guarantee the integrity of the repository in the event of inappropriate use.
     *
     * @param type Class of the object to create
     * @param identifier identifier of the object
     * @param referent MObject Referring MObject belonging to the current project. THe new create object will be add in the same repository as this object
     * @return New instanceof of MObject
     * @throws IllegalArgumentException if and object with the same id already exist in the curent repository
     */
    @objid ("4e085be5-0383-4af0-b589-539f189796a6")
    @Override
    @Deprecated(forRemoval = false)
    public MObject createElement(java.lang.Class<? extends MObject> type, String identifier, MObject referent) throws IllegalArgumentException {
        CoreSession session =(CoreSession)this.openedProject.getSession();

        IRepositorySupport support = session.getRepositorySupport();
        SmFactory smFactory = session.getSmFactory();
        SmMetamodel metamodel = session.getMetamodel();

        return smFactory.createObject(metamodel.getMClass(type), support.getRepository(referent),identifier);
    }
    ...
    @Override
    @Deprecated
    public Document createExternDocument(final String moduleName, final String documentRole, final ModelElement owner, final String mimeType) throws IOException, ExtensionNotFoundException {
    ...
    @Override
    @Deprecated
    public Document createExternDocument(final String moduleName, final String documentRole, final ModelElement owner, final String mimeType, final Path initialContent) throws IOException, ExtensionNotFoundException {
    ...
    /**
     * Create a ExternElement. The created ExternElement has no composition owner. In order to build a valid model, a composition owner must be defined. The returned object is an IExternElement representing the Abstraction in the Model.
     *
     * @return An IExternElement representing the ExternElement in the Model.
     */
    @objid ("0fc41bd1-c26b-481f-8436-79e6c7af8087")
    @Override
    public ExternElement createExternElement() {
        return this.modelService.getModelFactory().getFactory(IStandardModelFactory.class).createExternElement();
    }
     ...
     * @return An IExternElement representing the ExternElement in the Model.
     */
    @objid ("c9c4643f-48ff-4ed4-b512-66e8167f050a")
    @Override
    public ExternElement createExternElement(String name, MethodologicalLink owner, Stereotype stereotype) {
        return this.modelService.getModelFactory().getFactory(IStandardModelFactory.class).createExternElement(name, owner, stereotype);
    }

    @objid ("378b81a4-f886-4b97-835b-b1d96c0b8272")
    @Override
    public ExternElement createExternElement(String name, MethodologicalLink owner, String moduleName, String stereotypeName) throws ExtensionNotFoundException {
        return this.modelService.getModelFactory().getFactory(IStandardModelFactory.class).createExternElement(name, owner, moduleName, stereotypeName);
    }

    /**
     * Create a MethodologicalLink.
     *
     * @return An IMethodologicalLink representing the MethodologicalLink in the Model.
     */
    @objid ("cfcc4ef9-6ccb-431b-aead-22c8c0c5a10f")
    @Override
    public MethodologicalLink createMethodologicalLink() {
        return this.modelService.getModelFactory().getFactory(IStandardModelFactory.class).createMethodologicalLink();
    }
     ...
     * @return An IMethodologicalLink representing the MethodologicalLink in the Model.
     */
    @objid ("d2f5c649-27ff-4b76-a8b2-53e04e5825c3")
    @Override
    public MethodologicalLink createMethodologicalLink(ModelElement source, ModelElement destination, Stereotype stereotype) {
        return this.modelService.getModelFactory().getFactory(IStandardModelFactory.class).createMethodologicalLink(source, destination, stereotype);
    }

    @objid ("95d660b6-84f1-45e6-a254-868f6608a656")
    @Override
    public MethodologicalLink createMethodologicalLink(ModelElement source, ModelElement destination, String moduleName, String stereotypeName) throws ExtensionNotFoundException {
        return this.modelService.getModelFactory().getFactory(IStandardModelFactory.class).createMethodologicalLink(source, destination, moduleName, stereotypeName);
    }
