...
public class PatternService implements IPatternService {
    ...
    @Override
    public void exportPattern(final Package modelPattern, final Path patternPath) throws PatternException {
    ...
    @Override
    public void addPattern(final Path patternPath) throws PatternException {
    ...
    @Override
    public void applyPattern(final String patternName, final Map<String, Object> parameters) throws PatternException {
        RuntimePattern pattern = this.patternService.getCatalog().getPattern(patternName);
        if (pattern == null) {
