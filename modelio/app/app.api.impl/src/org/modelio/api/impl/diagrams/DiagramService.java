...
public class DiagramService implements IDiagramService {
    ...
    @objid ("b6298d48-8903-4608-bd25-88615220ba23")
    @Override
    public void layoutDiagram(final AbstractDiagram diagram) {
        ILayoutAlgorithme layoutAlgorithme = DiagramLayoutEngine.createLayoutAlgorithme(diagram, this);
    ...
    public void registerDiagramContributor(ContributorCategory category, IDiagramWizardContributor contributor) {
        this.eclipseContext.get(CreationContributorManager.class).addContribution(category, contributor);
    }
    ...
    public void unregisterDiagramContributor(ContributorCategory category, IDiagramWizardContributor contributor) {
        this.eclipseContext.get(CreationContributorManager.class).removeContribution(category, contributor);
    }

    @objid ("abb89236-1205-4f22-8fc9-9d45e4946d6d")
    @Override
