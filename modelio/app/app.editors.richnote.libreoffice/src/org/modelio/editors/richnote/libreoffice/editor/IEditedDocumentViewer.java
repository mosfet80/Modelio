...
public interface IEditedDocumentViewer {
    ...
    abstract void openDocument(final InputStream stream, final boolean modifiable) throws IOException;
    ...
    abstract void saveDocument(final OutputStream stream) throws IOException;
    ...
    abstract String getAsText() throws IOException;
    ...
    abstract String getAsHtml() throws IOException;
    ...
    abstract void createPartControl(final Composite parent);
    ...
    abstract void openDocument(final Path file, final boolean modifiable) throws IOException;
    ...
    abstract void createDocument(final Document doc, RichNoteFormat format) throws IOException;
    ...
    abstract void closeDocument() throws IOException;
     ...
     * @throws IllegalStateException if the viewer is not yet initialized.
     * {@linkplain #createPartControl(Composite)} must be called first.
     */
    @objid ("bedcf84c-edcd-48a2-9bd1-135d145ebd84")
    abstract boolean isDisposed() throws IllegalStateException;
    ...
    abstract void setFileManager(IRichNoteFileRepository aFileManager);
