...
public class DefaultEditCreatedElementCommand extends Command implements ICreationCommand<IGmLinkable>, ILinkAndNodeCreationSupport {
    @objid ("4d82fbf5-1e7f-43cd-ac36-9aee5ac4e488")
    private final Map editPartRegistry;
    ...
    public void execute() {
        ...
        if(this.creationCommand instanceof ICreationCommand) {
            ...
            IGmLinkable createdGraphicModel = ((ICreationCommand<?>)this.creationCommand).getCreatedGraphicModel();
            EditPart editPart = (EditPart) this.editPartRegistry.get(createdGraphicModel);
            if(editPart != null) {
    ...
    @objid ("61e3c11e-7f0d-4ae3-a8e9-c769eee652ca")
    @Override
    public String getLabel() {
        return this.creationCommand.getLabel();
    }
