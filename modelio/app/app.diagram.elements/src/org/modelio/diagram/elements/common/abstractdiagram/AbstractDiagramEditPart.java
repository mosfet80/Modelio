...
public class AbstractDiagramEditPart extends AbstractNodeEditPart {
    ...
    protected static final String DRAWINGLAYER_ROLE = "AWINGLAYER_ROLE";

    /**
     * ID of the layer pane where drawing layers are put.
     */
    @objid ("9eeff616-9943-42e1-8193-1a4fa86532d1")
    public static final String DRAWING_LAYER = "YER_PANE_DRAWING";

    /**
     * Fill image transparency property key.
     */
    @objid ("90df2c9c-1e83-11e2-8cad-001ec947c8cc")
    public static final String PROPERTY_FILL_ALPHA = "stractDiagramEditPart.FillAlpha";

    /**
     * Diagram fill color property key.
     */
    @objid ("90df2c90-1e83-11e2-8cad-001ec947c8cc")
    public static final String PROPERTY_FILL_COLOR = "stractDiagramEditPart.FillColor";

    /**
     * Fill image property key.
     * <p>
     * This may be a file path or an URL. Relative file paths may be supported if
     * {@link #refreshFromStyle(IFigure, IStyle)} uses {@link #resolvePath(String)}.
     */
    @objid ("90df2c96-1e83-11e2-8cad-001ec947c8cc")
    public static final String PROPERTY_FILL_IMAGE = "stractDiagramEditPart.FillImage";

    /**
     * Fill tile size property key.
     */
    @objid ("90df2ca2-1e83-11e2-8cad-001ec947c8cc")
    public static final String PROPERTY_FILL_TILE_SIZE = "stractDiagramEditPart.FillTileSize";

    /**
     * Grid transparency property key.
     */
    @objid ("90df2c8a-1e83-11e2-8cad-001ec947c8cc")
    public static final String PROPERTY_GRID_ALPHA = "stractDiagramEditPart.GridAlpha";

    /**
     * Grid color property key.
     */
    @objid ("90df2c84-1e83-11e2-8cad-001ec947c8cc")
    public static final String PROPERTY_GRID_COLOR = "stractDiagramEditPart.GridColor";

    @objid ("1bc248aa-4534-43e9-b0d5-aa7fc73afef9")
    public static final String PROPERTY_ANCHOR_SPACING = "stractDiagramEditPart.AnchorSpacing";
    ...
    /**
     * In order to provide snap to grid facility the AbstractEditPart must be
     * adaptable to a SnapToHelper. Here we adapt to a SnapToGrid only if the style
     * defines SNAPTOGRID = true
     */
    ...
    /**
     * Diagrams are usually not selected, in the case it happens return the
    ...
    /**
     * Redefined to add {@link DrawingLayerEditPart} layers in the drawing layer
     * pane.
     * <p/>
     * Subclasses willing to redefine this method must redefine
     * {@link #doAddChildVisual(EditPart, int)} instead, so that they won't be
     * annoyed by drawing layers.
     */
     ...
     * <p>
     * The layer pane is put on top of the {@link LayerConstants#PRINTABLE_LAYERS}
     * layer.
     *
    ...
    protected void createEditPolicies() {
        ...
        // Override the default drop policy with a specific one that can also handle
        // links.
    ...
    /**
     * Encapsulate layout edit policies into
     * {@link #createLayoutPolicyDecorator(EditPolicy)}.
     * <p>
     * May be redefined by sub classes.
     *
     * @param layoutPolicy the layout edit policy. expected to be a
     * {@link ConstrainedLayoutEditPolicy} by default
     * implementation.
    ...
    protected EditPolicy createLayoutPolicyDecorator(EditPolicy layoutPolicy) {
        ...
        return new LayoutConnectionsConstrainedLayoutEditPolicyDecorator(
        (ConstrainedLayoutEditPolicy) layoutPolicy);
        else
        return layoutPolicy;
    }
     ...
     * <p>
     * By default calls
     * {@link AbstractGraphicalEditPart#addChildVisual(EditPart, int)}
     */
     ...
     * <p>
     * By default calls
     * {@link AbstractGraphicalEditPart#removeChildVisual(EditPart)}
     */
    ...
    protected void refreshFromStyle(IFigure aFigure, IStyle style) {
        ...
        int anchorSpacing = style.getInteger(GmAbstractDiagramStyleKeys.ANCHORSPACING);
        ...
        // TODO: in the future this parsing might become the responsibility of the
        // property view,
        // ie the property view would propose a 'Dimension' editor returning the proper
        // 'in pixel' dimension value...
        ...
        v.setProperty(AbstractDiagramEditPart.PROPERTY_ANCHOR_SPACING, anchorSpacing);
    ...
    /**
     * Resolve the given path against the project directory if it is a relative file
     * path or a relative URL.
     * <p>
     ...
     * <p>
     * Currently preview data is a UUBase64Compressor compressed string of the PNG
    ...
    private ImageTransformationData updatePreviewData() {
        ImageBuilder ib = new ImageBuilder().withMaxSize(3840, 2160);
    ...
    /**
     * Update the 'JsAttribute(' for the diagram. Currently JsAttribute is a
     * serialisaiton of position of .
     */
    ...
    private void updateJsAttribute(ImageTransformationData transfo) {
        ...
        Point absoluteTranslation = new Point((int) ((diagramAbsolute.x / zoomFactor) - diagramRelative.x),
        ...
        serialiseDiagramLink(absoluteTranslation, zoomFactor, transfo, builder, link,
    ...
    private void serialiseDiagramLink(Point absoluteTranslation, float zoomFactor, ImageTransformationData transfo, StringBuilder builder, IDiagramLink link, Point first, Point second) {
        ...
        builder.append(",");
        builder.append(
        (int) (((xmid / zoomFactor) - absoluteTranslation.x + transfo.getDeltaX()) * transfo.getScale()));
        builder.append(",");
        builder.append(
        (int) (((ymid / zoomFactor) - absoluteTranslation.y + transfo.getDeltaY()) * transfo.getScale()));
        builder.append(",");
        builder.append(0);
        builder.append(",");
        builder.append(0);
    ...
    protected static class PageSizeParser {
        @objid ("aa84630c-4863-4254-81e2-1b40d3e49516")
        private static final Pattern NOT_A_NUMBER = Pattern.compile("[^0-9\\.]");

        @objid ("3d78e9e4-ca30-44fe-b809-c058f83ea7c5")
        private static final Pattern PAGE_FORMAT = Pattern.compile("(\\d+\\.?\\d*.*)(x)(\\d+\\.?\\d*.*)",
        ...
        private static final PrecisionDimension parsePageSize(String value) {
            ...
            width = Float.parseFloat(NOT_A_NUMBER.matcher(widthString).replaceAll("")) / oneInch; // 1 inch =
                           // 25,4 mm
            }
            ...
            // convert mm to inches
            height = Float.parseFloat(NOT_A_NUMBER.matcher(heightString).replaceAll("")) / oneInch; // 1 inch =
                           // 25,4 mm
            }
