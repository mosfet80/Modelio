...
public class DefaultPolygonDecoration extends PolygonDecoration implements IPenOptionsSupport, IBrushOptionsSupport {
    ...
    @objid ("b1d89dc8-dd6a-4425-b490-ff5c5fb46af1")
    public DefaultPolygonDecoration() {
        setAntialias(SWT.ON);
    }
    ...
    protected void outlineShape(Graphics g) {
        // Workaround tiny space sometimes between outline and fill
        g.setLineWidthFloat(getLineWidthFloat() * 1.1f);
