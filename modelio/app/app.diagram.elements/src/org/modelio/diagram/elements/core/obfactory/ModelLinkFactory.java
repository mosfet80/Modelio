...
public class ModelLinkFactory implements IModelLinkFactory {
     ...
     * @throws IllegalArgumentException if the asked metaclass is not a link metaclass
     * @throws ClassCastException if one of the source or destination element is a bad class for the link.
     */
     ...
     * @return The created link element
     * @throws IllegalArgumentException if the asked metaclass is not a link metaclass
     * @throws ClassCastException if one of the source, destination or owner element is a bad class for the link.
     */
    ...
    private static class ImplUmlVisitor extends DefaultModelVisitor {
         ...
         * @throws IllegalArgumentException if the 2 elements have no common namespace
         */
    ...
    private static class BindingLinkFactory {
         ...
         * @throws IllegalArgumentException if the given arguments don't allow creation of a binding link.
         */
         ...
         * @throws IllegalArgumentException if no matching collaboration use was found
         */
