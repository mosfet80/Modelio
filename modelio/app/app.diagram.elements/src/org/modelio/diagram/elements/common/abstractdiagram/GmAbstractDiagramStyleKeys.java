...
public class GmAbstractDiagramStyleKeys extends ElementsAbstractStyleKeyProvider {
    ...
    @objid ("0a8aed00-8cc1-475c-a7c6-bf7ea960d90a")
    public static final StyleKey ANCHORSPACING = createStyleKey("ABSTRACT_DIAGRAM_ANCHORSPACING", MetaKey.ANCHORSPACING);
