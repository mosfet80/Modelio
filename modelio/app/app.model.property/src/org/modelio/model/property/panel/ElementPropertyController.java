...
public class ElementPropertyController {
    ...
    public boolean canAddStereotype() {
        ...
        return selectedElement instanceof ModelElement && selectedElement.getStatusLazy().isModifiable();
    }
    ...
    public ElementPropertyUi createView(Composite parent) {
        ...
        Preferences.getPreferences().addPropertyChangeListener(new IPropertyChangeListener() {
            @Override
            public void propertyChange(PropertyChangeEvent event) {

                if (ElementPropertyController.this.ui.getComposite().isDisposed()) {
                    Preferences.getPreferences().removePropertyChangeListener(this);
                } else {
    ...
    public boolean isAdminMode() {
        return Preferences.getPreferences().getBoolean(AppSharedPreferencesKeys.SHOWADMTOOLS_PREFKEY);
    }
