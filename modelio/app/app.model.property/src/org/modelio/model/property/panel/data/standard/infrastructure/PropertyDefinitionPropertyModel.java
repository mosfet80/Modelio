...
public class PropertyDefinitionPropertyModel extends AbstractPropertyModel<PropertyDefinition> {
    ...
    private Object getValue(int row, int col) {
        ...
        case 1: // col 1 is the property value
            ...
            case 5:
                return getConstrainedMetaclassName();
            case 6:
    ...
    public INatValue getValueAt(int row, int col) {
        ...
        case 1: // col 1 is the property value type
            MMetamodel metamodel = this.theEditedElement.getMClass().getMetamodel();
            switch (row) {
            case 0: // Header
                return new DefaultStringNatValue((String) getValue(row, col), false);
            case 1:
                ...
                if (mcName != null) {
                    ...
                    stereotypeValue.setElementFilter( (MObject o) -> {
                        ...
                        if (baseClassName==null)
                            return false;
                        MClass steMm = metamodel.getMClass(baseClassName);
                        if (steMm == null)
                            return false;
                        return steMm.hasBase(metaclass);
                    });
                }
    ...
    public void setValueAt(int row, int col, Object value) {
        ...
        case 1: // col 1 is the property value
            ...
            case 5:
                ...
                break;
            case 6:
                String strVal = value != null ? ((Element) value).toString() : null;
                this.theEditedElement.setProperty("Constraints", "stereotype", strVal);
                break;
            default:
                return;
            }
    ...
    private String getConstrainedMetaclassName() {
