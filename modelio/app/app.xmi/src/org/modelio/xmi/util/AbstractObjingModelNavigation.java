...
public abstract class AbstractObjingModelNavigation {
    ...
    private static BindableInstance copyAssocEndToBindableInstance(AssociationEnd initial, Property ecoreElt) {
    ...
    private static void setMultiMax(Instance objingElt, Property ecoreElt) {
    ...
    private static void setMultiMin(Instance objingElt, Property ecoreElt) {
    ...
    private static void setInstance(Instance objingElt, Property ecoreElt) {
