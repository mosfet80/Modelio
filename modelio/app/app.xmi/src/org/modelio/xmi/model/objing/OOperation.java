...
public class OOperation extends OFeature {
    @objid ("a946678a-85df-43b3-8abe-5024021b22db")
    ...
    private void setRedefinedSignature(org.eclipse.uml2.uml.RedefinableTemplateSignature ecoreElt) {
        Operation redefines = this.objingElement.getRedefines();
        org.eclipse.uml2.uml.Element ecoreOperation = GenerationProperties.getInstance().getMappedElement(redefines);
