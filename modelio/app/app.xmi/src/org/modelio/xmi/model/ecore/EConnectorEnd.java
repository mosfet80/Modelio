...
public class EConnectorEnd extends EElement {
    ...
    private void setName(LinkEnd linkEnd) {
        linkEnd.setName(ObjingEAnnotation.getName(this.ecoreElt));
    }

    @objid ("05f620a8-a876-4165-8844-a6823b2882c4")
    private void setIsNavigable() {
        org.eclipse.uml2.uml.Element owner = this.ecoreElt.getOwner();
    ...
    private void setIsOrdered(LinkEnd linkEnd) {
        linkEnd.setIsOrdered(getEcoreElement().isOrdered());
    }

    @objid ("729aaa99-835c-4fee-b7c6-69ea6385c25e")
    private void setIsUnique(LinkEnd linkEnd) {
        linkEnd.setIsUnique(getEcoreElement().isUnique());
    }

    @objid ("180ea1b8-95a1-4d0c-ae07-dbe6f3b10e54")
    private void setMin(LinkEnd objingElt) {
        objingElt.setMultiplicityMin(EcoreModelNavigation.getMultiplicityMin(getEcoreElement()));
    }

    @objid ("24b56299-c56a-4253-a748-ad64d94e3581")
    private void setMax(LinkEnd objingElt) {
        objingElt.setMultiplicityMin(EcoreModelNavigation.getMultiplicityMax(getEcoreElement()));
    }
    ...
    @Override
    public org.eclipse.uml2.uml.ConnectorEnd getEcoreElement() {
        return (org.eclipse.uml2.uml.ConnectorEnd) this.ecoreElt;
    }
