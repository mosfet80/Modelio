...
public class OBindableInstance extends OInstance {
    ...
    public void setProperties(org.eclipse.uml2.uml.Element ecoreElt) {
        if (ecoreElt instanceof Property) {
            ...
            setRepresentedFeature((Property) ecoreElt);
    ...
    @objid ("4002dfd3-1f63-40d7-9319-199f37b1a668")
    private void setRepresentedFeature(Property ecoreElt) {
        BindableInstance bi = getObjingElement();
        ...
        if ((listProperty != null) && (listProperty.size() > 0) ){
            ...
            if ((base instanceof UmlModelElement) && (!base.equals(bi)))
                bi.setRepresentedFeature((UmlModelElement) base);
