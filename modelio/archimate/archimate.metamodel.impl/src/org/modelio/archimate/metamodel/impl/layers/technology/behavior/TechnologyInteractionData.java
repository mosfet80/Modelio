...
@objid ("0bf06326-276f-432a-ba51-823fc1908f59")
public class TechnologyInteractionData extends TechnologyInternalBehaviorElementData {
    @objid ("0101cd89-b772-422d-9212-298ba14704f8")
    public TechnologyInteractionData(TechnologyInteractionSmClass smClass) {
        super(smClass);
    }
