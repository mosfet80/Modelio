...
@objid ("a7028d5a-1e72-4d86-8423-46703223ac23")
public class StructuralRelationshipData extends RelationshipData {
    @objid ("57bb2834-2d58-4a4e-997e-88351074d65d")
    public StructuralRelationshipData(StructuralRelationshipSmClass smClass) {
        super(smClass);
    }
