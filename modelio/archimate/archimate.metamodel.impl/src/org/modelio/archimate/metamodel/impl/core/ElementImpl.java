...
@objid ("881064ac-9319-4fcd-bfc0-abb7ea9d9809")
public class ElementImpl extends ConceptImpl implements Element {
    @objid ("ddcb8222-aa65-4d5e-bed4-375e28a3f06c")
    @Override
    ...
    @objid ("59a9de85-d720-4b63-a960-dd171799e12b")
    @Override
    ...
    @objid ("550c608a-f9b5-4807-80e9-e275b3e3816e")
    @Override
