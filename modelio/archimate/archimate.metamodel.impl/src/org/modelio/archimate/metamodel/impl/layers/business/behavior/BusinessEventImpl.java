...
@objid ("3c2d5263-b1d4-4e3d-886e-43f16b344577")
public class BusinessEventImpl extends EventImpl implements BusinessEvent {
    @objid ("ced78b76-bfec-48da-a5af-a42e32940f84")
    @Override
    ...
    @objid ("97b623ff-f24b-4f04-a09c-0a193bca4e38")
    @Override
    ...
    @objid ("5c4c9efd-a496-403b-8254-935c654d31fe")
    @Override
    public Object accept(IArchimateVisitor v) {
        return v.visitBusinessEvent(this);
    }
