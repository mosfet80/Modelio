...
@objid ("b7bdf828-f6c5-4501-90b5-1df4ac56da23")
public class StakeholderImpl extends MotivationElementImpl implements Stakeholder {
    @objid ("df6db5e0-586f-4872-979c-070fe0397e28")
    @Override
    ...
    @objid ("117c8a2e-e794-4044-8b9a-c4a4efc0e222")
    @Override
    ...
    @objid ("68507ff2-cd4a-4946-8e04-26e0b114efe3")
    @Override
    public Object accept(IArchimateVisitor v) {
        return v.visitStakeholder(this);
    }
