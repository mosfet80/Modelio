...
@objid ("e5c19250-82b6-4ef7-a94c-f63bd2bee52c")
public class NodeImpl extends TechnologyInternalActiveStructureElementImpl implements Node {
    @objid ("a5e76c24-7eab-477b-bb88-de7ca611974a")
    @Override
    ...
    @objid ("4894f600-e518-4127-955e-a427f468ae4a")
    @Override
    ...
    @objid ("e5c3a0a5-f960-4eb3-87dd-329158c33d8f")
    @Override
