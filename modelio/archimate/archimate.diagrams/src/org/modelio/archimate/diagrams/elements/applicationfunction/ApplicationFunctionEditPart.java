...
/**
 * EditPart for a {@link GmApplicationFunction} Node.
 */
@objid ("edfc4d1b-5567-48f0-9853-09b80b530662")
public class ApplicationFunctionEditPart extends ArchiElementEditPart {
    @objid ("18af8a67-3785-427e-91f8-9378b0ec536b")
    @Override
    ...
    @objid ("2fe9c12f-f462-48ab-8080-a5ed8b0cf986")
    @Override
    ...
    @objid ("186cc9a4-93da-4b77-9694-0cc62c58e7ed")
    @Override
