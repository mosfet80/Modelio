...
/**
 * Archimate Diagram editor input.
 */
@objid ("9d13ca92-b61c-43ff-b6c3-9d43eac7a8e1")
public class ArchimateDiagramEditorInput extends DiagramEditorInput {
    /**
     ...
     */
    @objid ("e5b4631f-4cbe-46c2-a701-0ec3d34c678a")
    public ArchimateDiagramEditorInput(IModelManager modelManager, AbstractDiagram diagram, GmDiagramCreator gmDiagramCreator) {
        super(diagram, modelManager, gmDiagramCreator);
    }

    @objid ("effffb5b-ecbf-43ce-99a9-8beb00d593b5")
    @Override
    public String getEditorId() {
        return ArchimateDiagramEditor.ID;
    }
