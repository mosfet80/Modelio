...
/**
 * EditPart for a {@link GmTriggering} Link.
 */
@objid ("a6fc5a18-c72b-4ff5-9eaf-244ac9e5a7a7")
public class TriggeringEditPart extends ArchiRelationshipEditPart {
    @objid ("96c5284a-4f51-4d2d-a72d-421114b179c8")
    @Override
