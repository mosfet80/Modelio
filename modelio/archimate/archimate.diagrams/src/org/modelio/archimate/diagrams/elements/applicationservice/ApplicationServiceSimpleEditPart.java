...
/**
 * EditPart for a {@link GmApplicationService} Node in simple mode.
 */
@objid ("ec1ab7e5-cddc-4826-8a06-3dae41f8548c")
public class ApplicationServiceSimpleEditPart extends ArchiElementEditPart {
    @objid ("2b1b2eae-3dad-47c3-944f-d15e30264e1a")
    @Override
    ...
    @objid ("301482bb-4634-4646-8964-1b55797c0ecb")
    @Override
    ...
    @objid ("f4e9d236-f9df-4340-ad09-cb4461ee5887")
    @Override
