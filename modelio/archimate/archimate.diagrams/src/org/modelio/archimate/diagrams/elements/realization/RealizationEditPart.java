...
/**
 * EditPart for a {@link GmRealization} Link.
 */
@objid ("5797f439-9712-4ed8-99dc-c3745ef029d8")
public class RealizationEditPart extends ArchiRelationshipEditPart {
    @objid ("82e56cf3-1927-4402-989e-32968a4e302b")
    @Override
    ...
    @objid ("c1dd57a9-5e7e-4f9a-aef7-f5fde40fe3ea")
    @Override
    protected void refreshFromStyle(IFigure aFigure, IStyle style) {
        ...
        if (genFigure.getTargetDecoration() != null && gmModel.getStyleKey(MetaKey.FILLCOLOR) != null) {
            ...
            ((DefaultPolygonDecoration) genFigure.getTargetDecoration()).setLinePattern(LinePattern.LINE_SOLID);
        }
