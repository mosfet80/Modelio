...
/**
 * EditPart for a {@link GmServing} Link.
 */
@objid ("46e2dd96-2e6e-4be6-93e1-1be4d2c705f0")
public class ServingEditPart extends ArchiRelationshipEditPart {
    @objid ("c0b0e71c-728c-41dc-b8f0-fec73ece7f9f")
    @Override
