...
/**
 * EditPart for a {@link GmRequirement} Node.
 */
@objid ("5813a1b5-91d7-453f-a8ac-1258424e6836")
public class RequirementEditPart extends ArchiElementEditPart {
    @objid ("4580e023-2491-49d7-98f7-cecc68cb32c3")
    @Override
    ...
    @objid ("062a88a7-f263-41be-9fa3-936aca77c7f7")
    @Override
    ...
    @objid ("8f80f012-c121-4c23-a0e1-8e012e380bb9")
    @Override
