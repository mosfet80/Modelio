...
public class PolluxWidgetConfigurator {
    ...
    /**
     * Configure a triplet (label, control, caption) to approach the Pollux
     ...
     * </ul>
     *
     * @param label the label naming the field placed above the control, can be
     * <code>null<code>
     * @param control the editable control of the field, cannot be <code>null<code>
     * @param caption a caption (usually a text) placed below the control, can be
     * <code>null<code>
     */
    ...
    @objid ("0731dcf5-ba8f-4283-bb4f-756c33f32e2a")
    public static void configureStyleForFieldLabel(Control label, FieldLabelStyle style) {
        configureStyleForFieldLabel(label);
        switch (style) {
        case INFO:
            label.setForeground(UIColor.BLUE);
            break;
        case ERROR:
            label.setForeground(UIColor.RED);
            break;
        default:
            label.setForeground(UIColor.GRAY);
            break;
     ...
     * </ul>
     *
     * The widgets must belong to the passed composite. The passed composite layout
     * is set to a grid layout and the controls are laid out in the passed
     * composite.
     *
     ...
     * <ul>
     * <li>set the widget layout data (include a vertical indent to separate the
     * next widget)</li>
     * <li>set the widget font (use a bigger bold font></li>
     * <li>set the widget color</li>
     * </ul>
     *
     * @param control the control to be used as header (usually a Label), cannot be
     * <code>null<code>
     */
    ...
    public static void configureHeaderField(Control control) {
        ...
        control.setFont(UIFont.LARGEB);
        control.setForeground(UIColor.COBALT_TEXT);
        control.setBackground(container.getBackground());
    ...
    @objid ("fbc66cc1-9cb3-46a5-a67c-f36118ed6836")
    public static void configureSubtitleField(Control control) {
        if (control == null) {
            throw new IllegalArgumentException("'control' cannot be null.");
        }
        Composite container = control.getParent();
    ...
    @objid ("ab8fa19e-df51-4385-9937-45b974927652")
    public static void configureStyleForSubtitleField(Control control) {
        if (control == null) {
            throw new IllegalArgumentException("'control' cannot be null.");
        }
        Composite container = control.getParent();
    ...
    @objid ("5afe2618-f381-4e53-9864-a57294d5fbab")
    public static void configureSubtitleStyle(Control control) {
        if (control == null) {
            throw new IllegalArgumentException("'control' cannot be null.");
        }
        Composite container = control.getParent();
    ...
    /**
     * This is similar to
     * {@link #configureSimpleCompositeField(Composite, Control, Control, Control)}
     * with an additional control typically used to open an advanced or specialized
     * editor for the value of the main control. For example a file value field has
     ...
     *
     * @param comp the composite parent of the laid out controls
     * @param label the label naming the field placed above the control, can
     * be <code>null<code>
     * @param mainControl the editable control of the field, cannot be
     * <code>null<code>
     * @param caption a caption (usually a text) placed below the control, can
     * be <code>null<code>
     * @param editControl typically a button that opens a specialized editor to set
     * the main control value, can be <code>null<code>
     */
    ...
    @objid ("006ab96b-d6dd-4ea7-92a7-0d2c88f3a7d5")
    public enum FieldLabelStyle {
        @objid ("705a53e2-2a0c-48d1-b97e-25c3055172c8")
        DEFAULT,
        @objid ("bf96379a-5990-4407-9798-657b0f1a9257")
        INFO,
        @objid ("43eca9d3-f524-4e9e-a4bf-691dd6a87ced")
        ERROR;
