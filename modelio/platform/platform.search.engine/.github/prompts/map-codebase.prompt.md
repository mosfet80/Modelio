...
tools:
  ['execute/runInTerminal', 'read/readFile', 'agent', 'edit/editFiles', 'search']
---
...
<process>
1. Check if .gsd/codebase/ already exists (offer to refresh or skip, with ask_questions tool)
2. Create .gsd/codebase/ directory structure
3. Spawn 4 parallel gsd-codebase-mapper ("🗺️ GSD Codebase Mapper") agents:
