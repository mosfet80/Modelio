...
<!-- Spawns 🔗 GSD Integration Checker via runSubagent() which has all audit expertise baked in -->
...
Store resolved model for use in agent spawning below.
...
runSubagent(
  ...
  # "First, read .github/agents/gsd-integration-checker.agent.md for your role and instructions.\n\n"
