...
tools: ['vscode/askQuestions', 'execute/runInTerminal', 'read/readFile', 'edit/editFiles', 'search']
---
...
Use ask_questions tool (functions.ask_questions):
...
- Don't create plans from this command — route to /gsd-plan-phase or /gsd-add-phase commands
  </anti_patterns>
