...
tools:
  ['vscode/askQuestions', 'execute/runInTerminal', 'read/readFile', 'agent', 'edit/createDirectory', 'edit/createFile', 'edit/editFiles', 'search', 'web']
---
...
runSubagent(
  ...
  # "First, read .github/agents/gsd-phase-researcher.agent.md for your role and instructions.\n\n"
...
Read and store context file contents for the planner agent. The `@` syntax does not work reliably across agent boundaries - content must be inlined.
...
runSubagent(
  ...
  # Note: `agentName` should already load the agent instructions.
  # If your environment does NOT, prepend this line to the prompt:
  # "First, read .github/agents/gsd-planner.agent.md for your role and instructions.\n\n"
...
runSubagent(
  ...
  # Note: `agentName` should already load the agent instructions.
  # If your environment does NOT, prepend this line to the prompt:
  # "First, read .github/agents/gsd-plan-checker.agent.md for your role and instructions.\n\n"
