...
tools:
  ['vscode/askQuestions', 'execute/runInTerminal', 'read/readFile', 'agent', 'edit/editFiles', 'search']
---
...
Store resolved models for use in agent calls below.
...
Spawn gsd-executor sub agent with plan reference:
...
# Optional: set this so GitHub can attribute the trailer to a real account.
# export COPILOT_COAUTHOR_EMAIL="your-handle@users.noreply.github.com"
git commit -m "$(cat <<EOF
docs(quick-${next_num}): ${DESCRIPTION}

Quick task completed.
Co-Authored-By: GitHub Copilot (profile: {executor_model} + {planner_model}) <noreply@github.com>
EOF
)"
```
