...
public interface IModelioEventService {
    ...
    abstract void postSyncEvent(IModelioService emitter, final ModelioEvent topic, final Object data);

    @objid ("000f3124-a9ae-106e-bbdd-001ec947cd2a")
    abstract void postAsyncEvent(IModelioService emitter, final ModelioEvent topic, final Object data);
