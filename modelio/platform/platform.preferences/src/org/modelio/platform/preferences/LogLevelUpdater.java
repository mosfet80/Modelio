...
public class LogLevelUpdater {
    /**
     * Set the {@link PluginLogger} log level from the {@link Preferences#getPreferences()} preference store.
     */
    @objid ("f77725b3-9cc6-4f19-9567-cacc79050c46")
    public static void setLogLevelFromPreferences() {
        // Get log level from preferences
        int preferedLogLevel = Preferences.getPreferences().getInt(AppSharedPreferencesKeys.LOGLEVEL_PREFKEY);
