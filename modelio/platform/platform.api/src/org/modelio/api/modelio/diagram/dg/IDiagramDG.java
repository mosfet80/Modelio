...
public interface IDiagramDG extends IDiagramNode {
    ...
    abstract List<IDiagramLink> getLinks();
    ...
    abstract List<IDiagramLayer> getLayers();
    ...
    abstract IDiagramLayer getLayer(String layerIdentifier);
    ...
    abstract IDiagramDrawingsLayer getDrawingsLayer(String layerIdentifier);
    ...
    abstract IDiagramElementsLayer getElementsLayer(String layerIdentifier);
