...
public interface IUmlModel {
     ...
     */
    @objid ("dbc8af27-ad74-4237-ad44-42b22627f2d0")
    @Deprecated
    MObject createElement(java.lang.Class<? extends MObject> type, String identifier, MObject referent) throws IllegalArgumentException;
     ...
     * @return An Actor representing the Actor in the Model.
     * @throws ExtensionNotFoundException if no stereotype matching the given name and the element metaclass is found
     */
     ...
     * @return An Artifact representing the Artifact in the Model.
     * @throws ExtensionNotFoundException if no type matching the given name and the element metaclass is found
     */
     ...
     * @throws IOException in case of failure creating the file.
     * @since 3.7
     */
     ...
     * @param mimeType the MIME type of the document.
     * @return An {@link Document} representing the document in the model.
     * @throws ExtensionNotFoundException if no {@link ResourceType document role} matching the given name and the element metaclass is found
     * @throws IOException in case of failure creating the file.
     * @since 3.7
     */
     ...
     * @return An UseCaseDependency representing the UseCaseDependency in the Model.
     * @throws ExtensionNotFoundException if there is no stereotype matching the name and the metaclass
     */
     ...
     * @return An TaggedValue representing the TaggedValue in the Model.
     * @throws ExtensionNotFoundException if no tag type matching the given name and the element metaclass is found
     */
