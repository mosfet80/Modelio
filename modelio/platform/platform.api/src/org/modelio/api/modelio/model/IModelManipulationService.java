...
public interface IModelManipulationService {
    ...
    abstract MObject clone(final MObject element);
    ...
    abstract List<MObject> copyTo(final Collection<? extends MObject> elements, final MObject to);
    ...
    abstract void moveTo(final Collection<? extends MObject> elements, final MObject to);
    ...
    abstract void moveTo(final Collection<? extends MObject> elements, final MObject to, final MObject oldParentHint);
