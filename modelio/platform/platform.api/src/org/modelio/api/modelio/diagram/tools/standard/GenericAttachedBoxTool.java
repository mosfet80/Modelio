 ...
 * <p>
 * {@link #postConfigure(IDiagramHandle, IDiagramGraphic, LinkRouterKind, ILinkRoute, Point, MObject, MObject, List)} is called by {@link #actionPerformed(IDiagramHandle, IDiagramGraphic, LinkRouterKind, ILinkRoute, Point)} .
 * <p>
...
public class GenericAttachedBoxTool extends DefaultAttachedBoxTool {
    ...
    @Override
    public void actionPerformed(final IDiagramHandle diagramHandle, final IDiagramGraphic graphic, final LinkRouterKind routerType, final ILinkRoute path, final Point point) {
    ...
    protected void postConfigure(final IDiagramHandle diagramHandle, final IDiagramGraphic parentGraphic, final LinkRouterKind routerType, final ILinkRoute path, final Point point, MObject parentElement, MObject newElement, List<IDiagramGraphic> newGraphics) {
        // nothing by default
    }
