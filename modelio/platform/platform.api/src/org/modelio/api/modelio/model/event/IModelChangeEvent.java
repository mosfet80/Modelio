...
public interface IModelChangeEvent {
    ...
    abstract List<IElementMovedEvent> getMoveEvents();
    ...
    abstract List<IElementDeletedEvent> getDeleteEvents();
    ...
    abstract Set<MObject> getCreationEvents();
    ...
    abstract Set<MObject> getUpdateEvents();
