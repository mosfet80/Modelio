...
public interface IModelingSession {
    ...
    /**
     * Get elements in the model from a metaclass and its name.
     * <p>
     * If <code>Element</code> is given, every elements in the model will be checked.
     * </p>
     *
     * @param <T> the returned elements type
     * @param metaclass the java interface of the metaclass to look for.
     * @param withSubMetaclasses if true search in child metaclass hierarchy too.
     * @param value the name to look for.
     * @return A collection of elements matching the parameters. Might be empty but never <code>null</code>.
     * @since 6.0.1
     */
    @objid ("0089d633-f556-4ea6-9993-d85a029c73bf")
    <T extends MObject> Collection<T> findByName(Class<T> metaclass, boolean withSubMetaclasses, String value);
     ...
     * @since 6.0.1
     */
    @objid ("11aec05a-cee9-4f46-a504-31fe61bfc235")
    Collection<? extends MObject> findByName(MClass metaclass, boolean withSubMetaclasses, String value);
