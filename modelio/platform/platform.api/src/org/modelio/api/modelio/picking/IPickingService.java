...
public interface IPickingService {
    ...
    abstract void registerPickingProvider(final IPickingProvider pickingProvider);
    ...
    abstract void unregisterPickingProvider(final IPickingProvider pickingProvider);
    ...
    abstract IPickingSession startPickingSession(final IPickingClient client);
    ...
    abstract void endPickingSession(final IPickingSession session);
