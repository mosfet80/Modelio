...
public interface IStatusChangeEvent {
    ...
    abstract Collection<MObject> getAccessChanged();
    ...
    abstract Collection<MObject> getCmsStatusChanged();
    ...
    abstract Collection<MObject> getAuditStatusChanged();
    ...
    abstract Collection<MObject> getShellStateChanged();
    ...
    abstract Collection<MObject> getStatusChanged();
