...
public interface INavigationService {
    ...
    abstract void addNavigationListener(INavigationListener listener);
    ...
    abstract void removeNavigationListener(INavigationListener listener);
    ...
    abstract void fireNavigate(MObject target);
    ...
    abstract void fireNavigate(List<MObject> targets);
