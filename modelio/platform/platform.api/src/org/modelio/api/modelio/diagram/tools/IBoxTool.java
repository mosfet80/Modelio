...
public interface IBoxTool extends IDiagramTool {
    ...
    abstract boolean acceptElement(final IDiagramHandle diagramHandle, IDiagramGraphic targetNode);
    ...
    abstract void actionPerformed(final IDiagramHandle diagramHandle, IDiagramGraphic parent, Rectangle rect);
