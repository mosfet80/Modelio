...
public interface IExchangeService {
    ...
    abstract void exportXmiFile(final XmiExportConfiguration configuration, final IProgressMonitor monitor) throws XmiException;
    ...
    abstract void importXmiFile(final XmiImportConfiguration configuration, final IProgressMonitor monitor) throws XmiException;
