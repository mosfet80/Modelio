...
Copyright © 2023 Communauté Modelio.org — Tous droits réservés.
...
Vous devriez avoir reçu une copie de la Licence Générale Publique GNU avec ce programme ; si ce n'est pas le cas, consultez : https://www.gnu.org/licenses/.

Ce produit inclus un logiciel développé par Apache Software Foundation https://www.apache.org/.
