...
=====  Modèles de travail image:images/attachment/modeliocom41/User_Documentation_fr/Project_SaaS/Projects__work_models_and_sub-projects_SaaS/svnfragment.png[svnfragment.png]
...
* image:images/attachment/modeliocom41/User_Documentation_fr/Project_SaaS/Projects__work_models_and_sub-projects_SaaS/uml.png[4] UML : Modélisation UML et BPMN.
* image:images/attachment/modeliocom41/User_Documentation_fr/Project_SaaS/Projects__work_models_and_sub-projects_SaaS/localmodule.png[5] Local Module : Extensions MDA.
* image:images/attachment/modeliocom41/User_Documentation_fr/Project_SaaS/Projects__work_models_and_sub-projects_SaaS/analyst.analystproject.png[analyst.analystproject.png] Analyste : Modélisation Analyste (Exigences, Dictionaires, Objectifs...)
* image:images/attachment/modeliocom41/User_Documentation_fr/Project_SaaS/Projects__work_models_and_sub-projects_SaaS/impactproject.png[impactproject.png] Impact : Analyse d'impact
* image:images/attachment/modeliocom41/User_Documentation_fr/Project_SaaS/Projects__work_models_and_sub-projects_SaaS/archimate.png[6] ArchiMate : Modélisation ArchiMate
